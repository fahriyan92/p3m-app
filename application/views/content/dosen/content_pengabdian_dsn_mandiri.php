                    ...
                    <form id="formnya" method="post" enctype="multipart/form-data">
                        <div class="tab">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="err-jns-pengabdian" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="radio" name="jenis_pengabdian" value="1" <?= $_SESSION['job'] === 'dosen' ? 'checked' : 'disabled' ?>>
                                        <span class="text-capitalize" for="fokus">pengabdian Dosen</span><br>
                                        <input type="radio" name="jenis_pengabdian" value="2" disabled>
                                ...
                                <?php if (empty($dt_proposal) == false) : ?>
                                    <input type="hidden" name="id_pengajuan" value="<?= $dt_proposal->id_pengajuan ?>">
                                <?php endif; ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">2. Bidang Fokus Pengabdian</label><br>
                                        <div class="err-fokus" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <?php foreach ($fokus as $fks) { ?>
                                            <input type="radio" name="fokus_pengabdian" <?= (empty($dt_proposal) !== false ? $fks->id_fokus == $dt_proposal->id_fokus ? 'checked' : '' : '') ?> value="<?= $fks->id_fokus ?>">
                                            <span class="text-capitalize" for="fokus_pengabdian"><?= $fks->bidang_fokus ?></span><br>
                                        <?php } ?>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">3. Tema Pengabdian</label>
                                        <div class="err-tema" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="text" value="<?= empty($dt_proposal) !== false ? $dt_proposal->tema : '' ?>" class="form-control" placeholder="Tema pengabdian" name="tema_pengabdian">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">4. Sasaran Mitra (Jika Ada)</label>
                                        <input type="text" value="<?= empty($dt_proposal) !== false ? $dt_proposal->sasaran !== "null" ? $dt_proposal->sasaran : '' : '' ?>" class="form-control" id="inputSasaran" placeholder="Sasaran pengabdian" name="sasaran_pengabdian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">5. Judul pengabdian</label>
                                        <div class="err-judul" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="text" value="<?= empty($dt_proposal) !== false ? $dt_proposal->judul : '' ?>" class="form-control" placeholder="Judul pengabdian" name="judul_pengabdian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="tahunpengabdianDosenPNBP">6. Tahun Usulan</label>
                                        <div class="err-thn-usulan" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="number" value="<?= empty($dt_proposal) !== false ? $dt_proposal->tahun_usulan : '' ?>" class="form-control" min="2020" max="2099" step="1" name="tahun_pengabdian">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="tglmulai">7. Lama Pengabdian (mulai)</label>
                                        <div class="err-mulai" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="date" value="<?= empty($dt_proposal) !== false ? $dt_proposal->mulai : '' ?>" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" placeholder="mulai" name="tgl_mulai">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="<?= empty($dt_proposal) !== false ? $dt_proposal->akhir : '' ?>" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" placeholder="akhir" name="tgl_akhir">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= empty($dt_proposal) !== false ? $dt_proposal->biaya : '' ?>" class="form-control" id="biayadiusulkan" placeholder="100000" name="biaya_diusulkan">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" class="form-control" id="ringkasan" name="ringkasan" rows="4"><?= empty($dt_proposal) !== false ? $dt_proposal->ringkasan : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" class="form-control" id="tinjauan" name="tinjauan" rows="4"><?= empty($dt_proposal) !== false ? $dt_proposal->tinjauan : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" class="form-control" id="ringkasan" name="metode" rows="4"><?= empty($dt_proposal) !== false ? $dt_proposal->metode : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
