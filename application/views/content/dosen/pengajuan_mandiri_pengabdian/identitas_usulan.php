                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                                ...
                                <form action="<?= $mode === 'tambah' ? site_url('pengajuan_mandiri_pengabdian/identitas_usulan/store') : site_url('pengajuan_mandiri_pengabdian/identitas_usulan/edit') ?>" method="post">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="inputJudul">1. Bidang Fokus Pengabdian</label><br>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">2. Tema Pengabdian</label>

                                        <input type="text" value="<?= isset($identitas) ? set_value('tema_penelitian') == true ? set_value('tema_penelitian') : $identitas->tema : set_value('tema_penelitian') ?>" class="form-control" placeholder="Tema Pengabdian" name="tema_penelitian">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= isset($identitas) ? set_value('sasaran_penelitian') == true ? set_value('sasaran_penelitian') : $identitas->sasaran : set_value('sasaran_penelitian') ?>" class="form-control" id="inputSasaran" placeholder="Sasaran Pengabdian" name="sasaran_penelitian">
                                    </div>
                                </div>
                            </div>
                            <?php //batas row 
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">4. Judul Pengabdian</label>
                                        <div class="err-judul" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="text" value="<?= isset($identitas) ? set_value('judul_penelitian') == true ? set_value('judul_penelitian') : $identitas->judul : set_value('judul_penelitian') ?>" class="form-control" placeholder="Judul Pengabdian" name="judul_penelitian">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" readonly value="<?= isset($identitas) ? set_value('tahun_penelitian') == true ? set_value('tahun_penelitian') : $identitas->tahun : date("Y") ?>" class="form-control" min="<?= date("Y") ?>" max="2099" step="1" name="tahun_penelitian">
                                        <?= form_error('tahun_penelitian', '<h5 style="color:red;font-size: 16px;">', '</h5>'); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="tglmulai">6. Lama Pengabdian (mulai)</label>
