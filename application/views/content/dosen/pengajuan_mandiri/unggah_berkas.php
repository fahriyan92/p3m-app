...
<div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                <form action="<?= site_url('pengajuan_mandiri/unggah_berkas/store') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                     ...
                     <?php endif; ?>                        
                        ...
                        <div class="col-md-12 mb-2">
                                    ...
                                    <h5 class="text-left" style="font-size:13px; color:red;">[#]Format Yang Bisa Diupload: pdf,doc,docx,xlsx</h5>
                        </div>                                                                   
 ...
 <script>
    ...
    $('#filePrposal').on('change', function() {
        ...
        if(!(regex2.test(value))){
            $(".err-proposal>h5").text("Extensi Tidak Didukung!");
            $('.err-proposal').show();
            ...
            if(file.size > 3145728){
                $(".err-proposal>h5").text("Maximal File Berukuran 3 MB !");
                $('.err-proposal').show();
                $(this).val('');
            }   else{
                $('.err-proposal').hide();
    ...
    $('#fileRab').on('change', function() {
        const regex2 = new RegExp("(.*?)\.(xls|xlsx)$");
        $('.err-rab').hide();
        const file = this.files[0];
        const value = $(this).val().toLowerCase();
        ...
        if(!(regex2.test(value))){
            $(".err-rab>h5").text("Extensi Tidak Didukung!");
            $('.err-rab').show();
            ...
            if(file.size > 3145728){
                $(".err-rab>h5").text("Maximal File Berukuran 3 MB !");
                $('.err-rab').show();
                $(this).val('');
