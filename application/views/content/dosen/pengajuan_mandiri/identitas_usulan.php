                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <div class="row">
                                <?php //row 
                                ?>
                                <form action="<?= $mode === 'tambah' ? site_url('pengajuan_mandiri/identitas_usulan/store') : site_url('pengajuan_mandiri/identitas_usulan/edit') ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" readonly value="<?= isset($identitas) ? $identitas->tahun : date("Y") ?>" class="form-control" min="<?= date("Y") ?>" max="2099" step="1" name="tahun_penelitian">
