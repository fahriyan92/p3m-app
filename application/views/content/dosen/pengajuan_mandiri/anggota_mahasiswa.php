            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <?php //row ?>
                                <form action="<?= $mode === 'tambah' ? site_url('pengajuan_mandiri/anggota_mahasiswa/store') : site_url('pengajuan_mandiri/anggota_mahasiswa/edit')?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= isset($mahasiswa[0]) ? set_value('angkatan1') == true ? set_value('angkatan1') : $mahasiswa[0]->angkatan : set_value('angkatan1') ?>"  class="form-control" id="inputSasaran" placeholder="Angkatan" name="angkatan1">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">4. Angkatan</label>
                                        <input type="number" value="<?= isset($mahasiswa[1]) ? set_value('angkatan2') == true ? set_value('angkatan2') : $mahasiswa[1]->angkatan : set_value('angkatan2') ?>"  class="form-control" id="inputSasaran" placeholder="Angkatan" name="angkatan2">
                                    </div>
