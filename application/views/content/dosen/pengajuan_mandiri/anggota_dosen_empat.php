        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <?php $no=1; foreach($anggota as $ang): ?>
                        <div class="row">
                    <h3 class="text-left">Data Anggota  <?= $no; ?> <span style="color:red;">*</span></h3>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="ketua">1. NIP</label>
                            <input type="text" class="form-control" name="nip1" disabled id="nidn_ketua" value="<?= $ang->nip ?>">
                        </div>
                    </div>                    
                    <div class="col-md-12">
                        <div class="form-group">
                                <label for="nidn">2. NAMA DOSEN</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" name="nama_dosen" value="<?= $ang->nama ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="jurusan">3. Jurusan</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" name="jurusan" value="<?= $ang->unit ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="pangkat">4. Pangkat / Jabatan Fungsional</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" id="pangkat" name="pangkat" value="<?= $ang->jenis_unit ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="id_sinta">5. ID-Sinta <span style="color:red;">*</span></label>
                                <div class="custom-file">
                                    <input type="number" class="form-control" disabled name="sinta1" value="<?= $ang->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_cv/').$ang->file_cv ?>" target="_blank"><?= $ketua->file_cv ?></a></h5>
                            </div>
                        </div>
