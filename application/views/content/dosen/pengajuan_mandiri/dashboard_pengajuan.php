      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <a href="<?= base_url("pengajuan_mandiri/identitas_usulan") ?>">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            $anggota = '#';
            if ($status > 0) {
              $anggota = site_url('pengajuan_mandiri/anggota_dosen_revisi');
            }
            ?>
          ...
          <!-- /.col -->
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <?php $mhs = site_url('pengajuan_mandiri/anggota_mahasiswa'); ?>
          ...
          <!-- /.col -->
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <?php $unggah = site_url('pengajuan_mandiri/unggah_berkas'); ?>
        ...
        <?php if ($status == 7 && isset($stat_anggota)) : ?>
          <div class="col-lg-12">
            <div class="card card-default">
              <div class="card-body">
                <form action="<?= site_url('C_penelitian_dsn_mandiri/finalkan') ?>" method="post">
      ...
      <div class="col-lg-12">
        <div class="card card-default">
          <div class="card-header">
            <h4>Petunjuk Pengusulan Penelitian Mandiri</h4>
          </div>
          <div class="card-body">
