...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Beranda / Evaluasi / MENU MONEV</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content pb-3">
                                        ...
                                        <?php if (!empty($get_proposal)) : ?>
                                            ...
                                            foreach ($get_proposal as $key) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="C_evaluasi_dosen/preview/<?= $key->id_pengajuan_detail ?>" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-book"></i></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        <?php endif ?>
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Proposal Pengabdian </h3>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
