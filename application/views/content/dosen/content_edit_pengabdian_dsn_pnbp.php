...
<input type="hidden" name="id_list_event" id="id_list_event" value="<?= $id_event ?>">
            ...
            <div class="card card-default">
                <div style="text-align:center;">
                    <ul class="nav nav-tabs nav-justified">
                        <li class="nav-item step"><a class="nav-link not-allowed" href="#tab_1">Identitas Usulan</a></li>
                        <li class="nav-item step"><a class="nav-link not-allowed" href="#tab_2">Data Dosen</a></li>
                        <li class="nav-item step"><a class="nav-link not-allowed" href="#tab_5">Mahasiswa</a></li>
                        <li class="nav-item step"><a class="nav-link not-allowed" href="#tab_6">File</a></li>
                    </ul>
                </div>
                    ...
                    <form id="formnya" method="post" enctype="multipart/form-data">
                        <div class="tab">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">1. Jenis Pengabdian</label><br>
                                        ...
                                        <span class="text-capitalize" for="fokus">Pengabdian Dosen</span><br>
                                        <input type="radio" name="jenis_penelitian" value="2" <?= $_SESSION['job'] === 'plp' ? 'checked' : 'disabled' ?>>
                                        <span class="text-capitalize" for="fokus">Pengabdian PLP</span><br>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                if (isset($lanjut_dosen['ketua'])) : ?>
										<input type="hidden" name="nidn1" value="<?= $lanjut_dosen["ketua"][0]->nidn ?>">
										<input type="hidden" name="id_sinta1" value="<?= $lanjut_dosen["ketua"][0]->id_sinta ?>">
										
										<?php if (isset($lanjut_dosen['anggota'])) : ?>
											<?php for($i=0; $i < count($lanjut_dosen['anggota']); $i++) {?>
												<input type="hidden" name="nidn1" value="<?= $lanjut_dosen['anggota'][$i]->nidn ?>">
												<input type="hidden" name="id_sinta1" value=" <?= $lanjut_dosen['anggota'][$i]->id_sinta ?>">
											<?php } ?>
										<?php endif; ?>

										<input type="hidden" name="cv_lama_ketua" value="<?= $lanjut_dosen['ketua'][0]->nidn ?>?<?= $lanjut_dosen['ketua'][0]->file_cv ?>">
										<input type="hidden" name="nidn_ketua" id="nidn_ketua" value="<?= $lanjut_dosen['ketua'][0]->nidn ?>">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">3. Bidang Fokus Pengabdian</label><br>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">4. Tema Pengabdian</label>
                                        <div class="err-tema" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->tema : '' ?>" class="form-control" placeholder="Tema Pengabdian" name="tema_penelitian">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">5. Sasaran Mitra (Jika Ada)</label>
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->sasaran !== "null" ? $dt_proposal->sasaran : '' : '' ?>" class="form-control" id="inputSasaran" placeholder="Sasaran Pengabdian" name="sasaran_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">6. Judul Pengabdian</label>
                                        <div class="err-judul" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->judul : '' ?>" class="form-control" placeholder="Judul Pengabdian" name="judul_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= empty($dt_proposal) !== true ? $dt_proposal->identitas_tkt : '' ?>" min="0" max="9" class="form-control" id="identitas_tkt" placeholder="1 - 9" name="identitas_tkt" >
                                    </div>
                                </div>
                                */ ?>
                            </div>
						...
						<div class="tab">
							<div class="row ml-1">
								...
								<div class="ml-auto mr-3">
									<button type="button" class="btn btn-primary" id="addAnggotaPolije">Tambah Anggota
									</button>
							...
							<div id="container_anggota_luar">
								<div class="row ml-1">
									...
									<div class="ml-auto mr-3">
										<button type="button" class="btn btn-primary" id="addAnggotaLuar">Tambah
											Anggota
										</button>
									</div>
								</div>
							...
							<br>
							<h6 id="alert_permintaan" style="color:red;display: none;">"Menunggu Respon Anggota Untuk
								Lanjut Pada Tahap Selanjutnya"</h6>
						</div>
						<div class="tab">
							<div class="row">
								<div class="col-sm-5">
							...
							<div class="row">
								<div class="col-sm-5">
									<div class="form-group">
										<label for="mahasiswa1">Nama Mahasiswa 2</label>
								...
								<div class="col-sm-5">
									<div class="form-group">
										<label for="angkatan2">Program Studi Mahasiswa 2</label>
				...
				<div class="form-anggota2">
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control select2 nm_dosen" style="width: 100%;" id="anggota2"
									name="nidn">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="text" disabled class="form-control ag2" id="dsn_pangkat2"
									   name="dsn_pangkat2">
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="number" class="form-control ag2" id="id_sinta3" value="" name="id_sinta"
									   readonly>
							</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="number" class="form-control ag2" id="scopus3" value="" name="scopus"
									   readonly>
							</div>
							<div class="err-sinta3" style="display:none;">
								<h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
				...
				<div class="form-no_ktp_luar">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="text" class="form-control ag2" id="alamat_luar" value=""
									   name="alamat_luar">
							</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="text" class="form-control ag2" id="gender_luar" value=""
									   name="gender_luar">
							</div>
...
<script>
    ...
    // console.log(semua_dosen)    
    // console.log(dosen)
</script>
<script src="<?= base_url() . JS_DOSEN; ?>pengajuan_pengabdian_edit_pnbp.js?random=<?= uniqid(); ?>"></script>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		*/
		...
		$('#btnSimpanAnggotaPolije').on('click', function (){
			...
			$.ajax({
				...
				if(datanya.status == 'error'){
					...
					toastr["success"]("Berhasil, Anggota Harus Menerima Permintaan !!");
					return;
				}
		...
		/*
		|============================================================
		| END NEW TAMBAH / LIST ANGGOTA DOSEN
		|============================================================
		*/
		...
		const tambah_mahasiswa = (data_mhs = null, index = null) => {
			...
			newSelectDiv.after().html(`<hr>
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="angkatan1">Program Studi Mahasiswa ${counter +1}</label>
                                        <input type="text" class="form-control" id="angkatan${counter +1}" placeholder="Program Studi" name="angkatan" value="${angkatan_mhs}">
                                    </div>
                                    <div class="err-angkatan_mhs" style="display:none;">
                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                    </div>
...
<?php if (isset($lanjut_dosen)) : ?>
    <script>
        ...
        if (anggota.length === 2) {
            ...
            $('#anggota2').val(anggota[3].nidn).trigger('change');
		...
		if (anggota.length === 3) {
            $('input[name="pakegak"]').trigger('click');
            $('input[name="pakegak"]').prop('disabled', true);
            $('#anggota1').val(anggota[1].nidn).trigger('change');
		...
		if (anggota.length === 4) {
            $('input[name="pakegak"]').trigger('click');
            $('input[name="pakegak"]').prop('disabled', true);
            $('#anggota1').val(anggota[2].nidn).trigger('change');
