            ...
            <div class="card card-default">
                <div style="text-align:center;">
                    <ul class="nav nav-tabs nav-justified">
                        <li class="nav-item step not-allowed"><a class="nav-link" href="#tab_1">Identitas Usulan</a></li>
                        <li class="nav-item step not-allowed"><a class="nav-link" href="#tab_2">Data Dosen</a></li>
                        <li class="nav-item step not-allowed"><a class="nav-link" href="#tab_5">Mahasiswa</a></li>
                        <li class="nav-item step not-allowed"><a class="nav-link" href="#tab_6">File</a></li>
                    </ul>
                </div>
                    ...
                    <form id="formnya" method="post" enctype="multipart/form-data">
                        <div class="tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">5. Sasaran Mitra</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="tglmulai">8. Lama Pengabdian (mulai)</label>
                                        <div class="err-mulai" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <input type="date" value="<?= empty($dt_proposal) !== true ? $dt_proposal->mulai : '22/07/2019' ?>" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" placeholder="mulai" name="tgl_mulai">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="<?= empty($dt_proposal) !== true ? $dt_proposal->akhir : '22/07/2020' ?>" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" placeholder="akhir" name="tgl_akhir">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= empty($dt_proposal) !== true ? $dt_proposal->biaya : '' ?>" class="form-control" id="biayadiusulkan" placeholder="1000000" name="biaya_diusulkan" readonly>
                                    </div>
                                </div>
                                <?php /*
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="angkatan1" placeholder="Program Studi Mhs" name="angkatan">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="angkatan2" placeholder="Program Studi Mhs" name="angkatan">
                                    </div>
                                    <div class="err-angkatan_mhs" style="display:none;">
                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                    </div>
...
<script src="<?= base_url() . JS_DOSEN; ?>pengajuan_pengabdian_pnbp.js?random=<?= uniqid(); ?>"></script>
...
<!--                                        <input type="text" class="form-control" id="angkatan${counter +1}" placeholder="Program Studi Mahasiswa" name="angkatan" >-->
<!--                                    </div>-->
<!--                                    <div class="err-angkatan_mhs" style="display:none;">-->
<!--                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>-->
<!--                                    </div>-->
