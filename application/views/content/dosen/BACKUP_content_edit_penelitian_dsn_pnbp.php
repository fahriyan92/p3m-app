                    ...
                    <form id="formnya" method="post" enctype="multipart/form-data">
                        <div class="tab">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <label for="statusTKT">14. Metode (max. 600 kata)</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="number" class="form-control" value="<?= $dosen['ketua'][0]->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta" readonly>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="number" class="form-control" value="<?= $dosen['ketua'][0]->scopus ?>" id="scopus1" onkeydown="return event.keyCode !== 69" name="scopus" readonly>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="angkatan1" placeholder="Angkatan Mhs" name="angkatan">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="angkatan2" placeholder="Angkatan Mhs" name="angkatan">
                                    </div>
                                    <div class="err-angkatan_mhs" style="display:none;">
                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                    </div>
...
<script src="<?= base_url() . JS_DOSEN; ?>pengajuan_edit_pnbp.js?random=<?= uniqid(); ?>"></script>
