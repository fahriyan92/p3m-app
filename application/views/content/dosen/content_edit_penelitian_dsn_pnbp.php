...
<input type="hidden" name="nidn" id="nidn_ketua" value="<?= $dosen['ketua'][0]->nidn ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <!-- <input type="hidden" name="id_pengajuan_detail" id="id_pengajuan_detail" value="<?=$id_pengajuan_detail?>"> -->
                        <div class="tab">
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <?php if (empty($dt_proposal) == false) : ?>
                                    <input type="hidden" id="id_pengajuan_detail" name="id_pengajuan_detail" value="<?= $dt_proposal->id_pengajuan_detail ?>">
