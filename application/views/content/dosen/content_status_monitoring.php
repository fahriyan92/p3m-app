...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Monitoring Penelitian</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Beranda / Monitoring-Penelitian / MENU MONEV </li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content pb-3">
                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <h3 class="card-title float-sm-right">Kuota Pengajuan di penelitian : <?= empty($hindex->limit_penelitian) ? '-' : $hindex->limit_penelitian . 'x'; ?></h3>
                                    </div>
                                    <div class="col-md-3">
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Proposal Penelitian </h3>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="table-responsive">
                                <table id="tabelpenelitian" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Judul</th>
                                        ...
                                        if (!empty($get_proposal)) : ?>
                                            ...
                                            foreach ($get_proposal as $key) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="C_monitoring_dosen/preview/<?= $key->id_pengajuan_detail ?>" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-book"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            endforeach; ?>
...
<script>
    const datatable = $('#tabelpenelitian, #tabelpengabdian').DataTable({
        "language": {
    ...
    $("#tabelpenelitian_filter, #tabelpengabdian_filter").append(
