                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h3 class="card-title float-sm-right">Kuota Pengajuan di pengabdian : <?= empty($hindex->limit_pengabdian) ? '-' : $hindex->limit_pengabdian . 'x'; ?></h3>
                                    </div>
                                    <div class="col-md-3">
                                        <h3 class="card-title float-sm-right">H-Index Scholar :
                                            <?= empty($hindex->h_index_schoolar) ? '-' : $hindex->h_index_schoolar; ?></h3>
                                    </div>
                                        ...
                                        <?php if (!empty($get_proposal)) : ?>
                                            ...
                                            foreach ($get_proposal as $key) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="C_pengabdian_dsn_pnbp/preview/<?= $key->id_pengajuan_detail ?>" class="btn btn-xs  btn-warning"><i class="fa fa-fw fa-book"></i></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        <?php endif ?>
