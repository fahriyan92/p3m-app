            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($dt_proposal)) : ?>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input id="flag_unggah" name="flag_unggah" hidden="hidden" value="">
                                <h2><strong>Lampirkan File <br></strong> </h2>

                                <div class="col-sm-12">
                                    <label for="cvKetua">Unggah File Pelaporan</label>
                                    <span style="color:red;"> ( *Unggah file jika ingin mengganti / menambahkan laporan )</span>
                                    <span style="color:red;"><br> ( *wajib unggah file )</span>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="fileCv" name="file_cv" hidden="hidden" enctype="multipart/form-data">
