                    ...
                    <div class="row">
                        ...
                        <div class="div-table w-100">
                            ...
                            <div class="table">
                                ...
                                <div class="tr">
                                    <div class="td">1</div>
                                    <div class="td">Satu artikel ilmiah (ICoFA atau ICoSHIP, atau publisher bereputasi
                                        lainnya, atau seminar internasional yang lain bila tidak lolos seleksi pada
                                        publisher prosiding ICoFA atau ICoSHIP</div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Satu artikel
                                                            ilmiah (ICoFA atau ICoSHIP, atau publisher bereputasi
                                                            lainnya, atau seminar internasional yang lain bila tidak
                                                            lolos seleksi pada publisher prosiding ICoFA atau ICoSHIP
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                ...
                                <div class="tr">
                                    <div class="td">2</div>
                                    <div class="td">Artikel di jurnal nasional terakreditasi minimal SINTA 3 atau 4
                                        dengan status minimal submitted</div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Artikel di
                                                            jurnal
                                                            nasional terakreditasi minimal SINTA 3 atau 4 dengan
                                                            status
                                                            minimal submitted</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                ...
                                <div class="tr">
                                    <div class="td">3</div>
                                    <div class="td">Satu Kekayaan Intelektual berupa Hak Cipta dengan status Granted
                                        atas nama Politeknik Negeri Jember</div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Satu Kekayaan
                                                            Intelektual berupa Hak Cipta dengan status Granted atas
                                                            nama
