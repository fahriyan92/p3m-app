                    ...
                    <div class="row">
                        ...
                        <div class="div-table w-100">
                            ...
                            <div class="table">
                                ...
                                <div class="tr">
                                    <div class="td">2</div>
                                    <div class="td">Satu artikel ilmiah berupa prosiding dari Seminar Internasional Polije (ICoFA atau ICoSHIP) yang diregistrasi di publisher bereputasi baik Institute of Physics (IOP) atau Atlantis Press(AP), atau publisher bereputasi lainnya, atau seminar internasional yang lain bila tidak lolos seleksi pada publisher prosiding ICoFA atau ICoSHIP</div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Satu artikel ilmiah berupa prosiding dari Seminar Internasional Polije (ICoFA atau ICoSHIP) yang diregistrasi di publisher bereputasi baik Institute of Physics (IOP) atau Atlantis Press(AP), atau publisher bereputasi lainnya, atau seminar internasional yang lain bila tidak lolos seleksi pada publisher prosiding ICoFA atau ICoSHIP</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                ...
                                <div class="tr">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_wb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_penelitian/up_wb4/$idproposal") : base_url("Upload_berkas_penelitian/edit_wb4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Luaran Wajib
                                                                            3</span>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <div class="custom-file">
                                                                        <input type="text" name="ds4" class="form-control" id="wb4" aria-describedby="emailHelp" placeholder="Masukkan Deskripsi Laporan Anda">
                                                                    </div>
                                                            ...
                                                            <?php if (isset($berkas->w_b4)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_penelitian/hapus_wb4/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_penelitian/up_wb4_url/$idproposal") : base_url("Upload_berkas_penelitian/edit_wb4_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b4)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/penelitian/") . $berkas->w_b4 . '">' . $berkas->w_b4 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_w4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_penelitian/tambah_d_w4/$idproposal") : base_url("Upload_berkas_penelitian/edit_d_w4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_penelitian/tambah_d_w4/$idproposal") : base_url("Upload_berkas_penelitian/edit_d_w4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_w4)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_penelitian/hapus_d_w4/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
...
<script>
    ...
    function MetodeLaporanCheck(fileSelect) {
        if (fileSelect) {
            kemajuanOptionValue = document.getElementById("laporan_kemajuan").value;
            akhirOptionValue = document.getElementById("laporan_akhir").value;
            keuanganOptionValue = document.getElementById("laporan_keuangan").value;
            if (kemajuanOptionValue == fileSelect.value) {
                document.getElementById("laporan_kemajuan_select").style.display = "block";
            } else {
                document.getElementById("laporan_kemajuan_select").style.display = "none";
            }
            if (akhirOptionValue == fileSelect.value) {
                document.getElementById("laporan_akhir_select").style.display = "block";
            } else {
                document.getElementById("laporan_akhir_select").style.display = "none";
            }
            if (keuanganOptionValue == fileSelect.value) {
                document.getElementById("laporan_keuangan_select").style.display = "block";
            } else {
                document.getElementById("laporan_keuangan_select").style.display = "none";
            }
        } else {
            document.getElementById("laporan_kemajuan_select").style.display = "none";
            document.getElementById("laporan_akhir_select").style.display = "none";
    ...
    function MetodeLuaranCheck(fileSelect) {
        if (fileSelect) {
            ...
            if (luaranUrlwb4OptionValue == fileSelect.value) {
