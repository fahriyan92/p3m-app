                    ...
                    <div class="row">
                        <div class="div-table w-100">
                            <div class="table">
                                ...
                                <div class="tr">
                                    <div class="td"></div>
                                    <div class="td font-weight-bold">File Laporan</div>
                                </div>
                                <div class="tr">
                                    <div class="td">1</div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="metode_file_kemajuan_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_kemajuan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_kemajuan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Laporan Kemajuan</span>
                                                                    </div>
                                                                    <div class="custom-file">
                                                                        <input name="berkas_laporan_kemajuan" type="file" class="custom-file-input" id="laporan_kemajuan" accept="application/pdf">
                                                                        <label class="custom-file-label" for="laporan_kemajuan">Choose
                                                                            file</label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php if (isset($berkas->b_laporan_kemajuan)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_berkas_laporan_kemajuan/$idproposal") ?>">
                                                        ...
                                                        <div id="metode_url_kemajuan_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_kemajuan_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_kemajuan_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                                                    <input type="url" class="form-control" name="berkas_laporan_kemajuan_url" id="laporan_kemajuan" aria-describedby="basic-addon3">
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->b_laporan_kemajuan) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->b_laporan_kemajuan)) : ?>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->b_laporan_kemajuan)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->b_laporan_kemajuan . '">' . $berkas->b_laporan_kemajuan . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="TidakdeskripsiKemajuan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_kemajuan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_kemajuan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_kemajuan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_kemajuan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_laporan_kemajuan)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_deskripsi_kemajuan/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="metode_file_akhir_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_akhir/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_akhir/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Laporan Akhir</span>
                                                                    </div>
                                                                    <div class="custom-file">
                                                                        <input name="berkas_laporan_akhir" type="file" class="custom-file-input" id="laporan_akhir" accept="application/pdf">
                                                                        <label class="custom-file-label" for="laporan_akhir">Choose
                                                                            file</label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php if (isset($berkas->b_laporan_akhir)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_berkas_laporan_akhir/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="metode_url_akhir_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_akhir_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_akhir_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                                                    <input type="url" class="form-control" name="berkas_laporan_akhir_url" id="laporan_akhir" aria-describedby="basic-addon3">
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->b_laporan_akhir) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->b_laporan_akhir)) : ?>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->b_laporan_akhir)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->b_laporan_akhir . '">' . $berkas->b_laporan_akhir . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="TidakdeskripsiAkhir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_akhir/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_akhir/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_akhir/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_akhir/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_laporan_akhir)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_deskripsi_akhir/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="metode_file_keuangan_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_keuangan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_keuangan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Laporan Keuangan</span>
                                                                    </div>
                                                                    <div class="custom-file">
                                                                        <input name="berkas_laporan_keuangan" type="file" class="custom-file-input" id="laporan_keuangan" accept="application/pdf">
                                                                        <label class="custom-file-label" for="laporan_keuangan">Choose
                                                                            file</label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php if (isset($berkas->b_laporan_keuangan)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_berkas_laporan_keuangan/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="metode_url_keuangan_select" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_berkas_laporan_keuangan_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_berkas_laporan_keuangan_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                                                    <input type="url" class="form-control" name="berkas_laporan_keuangan_url" id="laporan_keuangan" aria-describedby="basic-addon3">
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->b_laporan_keuangan) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->b_laporan_keuangan)) : ?>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->b_laporan_keuangan)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->b_laporan_keuangan . '">' . $berkas->b_laporan_keuangan . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="TidakdeskripsiKeuangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_keuangan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_keuangan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_deskripsi_keuangan/$idproposal") : base_url("Upload_berkas_pengabdian/edit_deskripsi_keuangan/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_laporan_keuangan)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_deskripsi_keuangan/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Artikel prosiding ber-ISBN
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_wb1" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->w_b1)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_wb1/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb1" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb1_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb1_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b1)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->w_b1 . '">' . $berkas->w_b1 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_w1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_w1)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_w1/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    <div class="td">2</div>
                                    <div class="td">Artikel pada media massa cetak atau elektronik</div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="w_b2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Artikel pada media massa cetak atau elektronik</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_wb2" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Luaran Wajib
                                                                            2</span>
                                                            ...
                                                            <?php if (isset($berkas->w_b2)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_wb2/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb2" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb2_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb2_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b2)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->w_b2 . '">' . $berkas->w_b2 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_w2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_w2)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_w2/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_wb3" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Luaran Wajib
                                                                            3</span>
                                                            ...
                                                            <?php if (isset($berkas->w_b3)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_wb3/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb3" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb3_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb3_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b3)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->w_b3 . '">' . $berkas->w_b3 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_w3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_w3)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_w3/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#w_b4">
                                            <?= empty($berkas->w_b4) ? 'Unggah File' : 'Edit / Hapus File' ?>
                                        </button>
                                        <div class="modal fade" id="w_b4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="file_luaran_wb4">PILIH METODE UNGGAH</label>
                                                            <select id="file_luaran_wb4" class="form-control" onchange="MetodeLuaranCheck(this);">
                                                                <option></option>
                                                                <option id="luaran_file_wb4">File</option>
                                                                <option id="luaran_url_wb4">URL</option>
                                                            </select>
                                                        </div>
                                                        <div id="luaran_file_select_wb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Luaran Wajib
                                                                            4</span>
                                                                    ...
                                                                    <div class="custom-file">
                                                                        <input name="wb4" type="file" class="custom-file-input" id="wb4" accept="application/pdf">
                                                                        <label class="custom-file-label" for="wb4">Choose
                                                                            file</label>
                                                                    </div>
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b4) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->w_b4)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_wb4/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb4_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb4_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                                                    <input type="url" class="form-control" name="wb4" id="wb4" aria-describedby="basic-addon3">
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b4) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->w_b4)) : ?>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b4)) {
                                            echo '<p>Masih Belum Ada File</p>';
                                        } elseif (filter_var($berkas->w_b4, FILTER_VALIDATE_URL)) {
                                            echo '<a target="_blank"href="' . $berkas->w_b4 . '">' . $berkas->w_b4 . '</a>';
                                        } else {
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->w_b4 . '">' . $berkas->w_b4 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                        <?php if (empty($deskripsi->d_w4)) : ?>
                                            <a type="button" data-toggle="modal" data-target="#Tidakd_w4">
                                                <button type="button" class="btn btn-danger">Klik Disini Untuk Menambahkan Deskripsi</button>
                                            </a>
                                            <div class="modal fade" id="Tidakd_w4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Deskripsi Luaran Wajib 4</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <textarea name="d_w4" class="form-control mb-3" aria-label="Tambahkan Deskripsi"></textarea>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($deskripsi->d_w4) ? 'Tambahkan Deskripsi' : 'Edit Deskripsi' ?>" />
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php else : ?>
                                            <a type="button" data-toggle="modal" data-target="#Adad_w4">
                                                <p class="text-break"><?= $deskripsi->d_w4 ?></p>
                                            </a>
                                            <div class="modal fade" id="Adad_w4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Deskripsi Luaran Wajib 4</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <textarea name="d_w4" class="form-control mb-3" aria-label="Tambahkan Deskripsi"></textarea>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b1) ? 'Tambahkan Deskripsi' : 'Edit Deskripsi' ?>" />
                                                                <?php if (isset($deskripsi->d_w4)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_w4/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#w_b5">
                                            <?= empty($berkas->w_b5) ? 'Unggah File' : 'Edit / Hapus File' ?>
                                        </button>
                                        <div class="modal fade" id="w_b5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Peningkatan Level Keberdayaan Mitra
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="file_luaran_wb5">PILIH METODE UNGGAH</label>
                                                            <select id="file_luaran_wb5" class="form-control" onchange="MetodeLuaranCheck(this);">
                                                                <option></option>
                                                                <option id="luaran_file_wb5">File</option>
                                                                <option id="luaran_url_wb5">URL</option>
                                                            </select>
                                                        </div>
                                                        <div id="luaran_file_select_wb5" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text">Luaran Wajib
                                                                            5</span>
                                                                    ...
                                                                    <div class="custom-file">
                                                                        <input name="wb5" type="file" class="custom-file-input" id="wb5" accept="application/pdf">
                                                                        <label class="custom-file-label" for="wb5">Choose
                                                                            file</label>
                                                                    </div>
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b5) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->w_b5)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_wb5/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_wb5" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_wb5_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_wb5_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                                                    <input type="url" class="form-control" name="wb5" id="wb5" aria-describedby="basic-addon3">
                                                                </div>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b5) ? 'Unggah File' : 'Edit File' ?>" />
                                                            </form>
                                                            <?php if (isset($berkas->w_b5)) : ?>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->w_b5)) {
                                            echo '<p>Masih Belum Ada File</p>';
                                        } elseif (filter_var($berkas->w_b5, FILTER_VALIDATE_URL)) {
                                            echo '<a target="_blank"href="' . $berkas->w_b5 . '">' . $berkas->w_b5 . '</a>';
                                        } else {
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->w_b5 . '">' . $berkas->w_b5 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                        <?php if (empty($deskripsi->d_w5)) : ?>
                                            <a type="button" data-toggle="modal" data-target="#Tidakd_w5">
                                                <button type="button" class="btn btn-danger">Klik Disini Untuk Menambahkan Deskripsi</button>
                                            </a>
                                            <div class="modal fade" id="Tidakd_w5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Deskripsi Luaran Wajib 5</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <textarea name="d_w5" class="form-control mb-3" aria-label="Tambahkan Deskripsi"></textarea>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($deskripsi->d_w5) ? 'Tambahkan Deskripsi' : 'Edit Deskripsi' ?>" />
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php else : ?>
                                            <a type="button" data-toggle="modal" data-target="#Adad_w5">
                                                <p class="text-break"><?= $deskripsi->d_w5 ?></p>
                                            </a>
                                            <div class="modal fade" id="Adad_w5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Deskripsi Luaran Wajib 5</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_w5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_w5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <textarea name="d_w5" class="form-control mb-3" aria-label="Tambahkan Deskripsi"></textarea>
                                                                <input style="width:100%" class="btn btn-primary" type="submit" name="Upload" value="<?= empty($berkas->w_b1) ? 'Tambahkan Deskripsi' : 'Edit Deskripsi' ?>" />
                                                                <?php if (isset($deskripsi->d_w5)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_w5/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    <div class="td">1</div>
                                    <div class="td">Artikel jurnal pengabdian masyarakat
                                    </div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="t_b1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Artikel jurnal pengabdian masyarakat
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_tb1" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->t_b1)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_tb1/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_tb1" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb1_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb1_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->t_b1)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->t_b1 . '">' . $berkas->t_b1 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_t1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t1/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t1/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_t1)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_t1/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="t_b2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Buku ber ISBN
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_tb2" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->t_b2)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_tb2/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_tb2" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb2_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb2_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->t_b2)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->t_b2 . '">' . $berkas->t_b2 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_t2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t2/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t2/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_t2)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_t2/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="t_b3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Bahan ajar
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_tb3" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->t_b3)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_tb3/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_tb3" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb3_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb3_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->t_b3)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->t_b3 . '">' . $berkas->t_b3 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_t3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t3/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t3/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_t3)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_t3/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    <div class="td">4</div>
                                    <div class="td">Metode atau sistem; Produk (Barang atau Jasa)
                                    </div>
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="t_b4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Metode atau sistem; Produk (Barang atau Jasa)
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_tb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->t_b4)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_tb4/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_tb4" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb4_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb4_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->t_b4)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->t_b4 . '">' . $berkas->t_b4 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_t4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t4/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t4/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_t4)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_t4/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
                                ...
                                <div class="tr">
                                    ...
                                    <div class="td">
                                        ...
                                        <div class="modal fade" id="t_b5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Perbaikan tata nilai masyarakat (seni budaya, sosial, politik, keamanan, ketenteraman, pendidikan, kesehatan)
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div id="luaran_file_select_tb5" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                            ...
                                                            <?php if (isset($berkas->t_b5)) : ?>
                                                                <form action="<?= base_url("Upload_berkas_pengabdian/hapus_tb5/$idproposal") ?>">
                                                                    <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                </form>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div id="luaran_url_select_tb5" style="display: none">
                                                            <form action="<?= empty($berkas) ? base_url("Upload_berkas_pengabdian/up_tb5_url/$idproposal") : base_url("Upload_berkas_pengabdian/edit_tb5_url/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon3">https://example.com/</span>
                                                                    </div>
                                    ...
                                    <div class="td">
                                        ...
                                        if (empty($berkas->t_b5)) {
                                            ...
                                            echo '<a target="_blank"href="' . base_url("assets/berkas/file_laporan/pengabdian/") . $berkas->t_b5 . '">' . $berkas->t_b5 . '</a>';
                                        }
                                        ?>
                                    </div>
                                    <div class="td">
                                            ...
                                            <div class="modal fade" id="Tidakd_t5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?= empty($deskripsi) ? base_url("Upload_berkas_pengabdian/tambah_d_t5/$idproposal") : base_url("Upload_berkas_pengabdian/edit_d_t5/$idproposal") ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <?php if (isset($deskripsi->d_t5)) : ?>
                                                                    <form action="<?= base_url("Upload_berkas_pengabdian/hapus_d_t5/$idproposal") ?>">
                                                                        <button style="width: 100%" class="btn btn-danger mt-2" type="submit">Hapus</button>
                                                                    </form>
                                                                <?php endif; ?>
                                                            </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="font-size: 14px">
                    ...
                    <p style="margin: 0; padding: 0;"><b>Mengubah Deskripsi</b> : Untuk Mengubah Teks Deskripsi Silahkan Klik Teks atau Kalimat Deskripsi Yang Ingin Dirubah</p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    ...
    function MetodeLuaranCheck(fileSelect) {
        if (fileSelect) {
            ...
            // Luaran Wajib 4
            luaranFilewb4OptionValue = document.getElementById("luaran_file_wb4").value;
            luaranUrlwb4OptionValue = document.getElementById("luaran_url_wb4").value;

            // Luaran Wajib 5
            luaranFilewb5OptionValue = document.getElementById("luaran_file_wb5").value;
            luaranUrlwb5OptionValue = document.getElementById("luaran_url_wb5").value;
            ...
            // Luaran Wajib 4
            if (luaranFilewb4OptionValue == fileSelect.value) {
                document.getElementById("luaran_file_select_wb4").style.display = "block";
            } else {
                document.getElementById("luaran_file_select_wb4").style.display = "none";
            }
            if (luaranUrlwb3OptionValue == fileSelect.value) {
                document.getElementById("luaran_url_select_wb4").style.display = "block";
            } else {
                document.getElementById("luaran_url_select_wb4").style.display = "none";
            }

            // Luaran Wajib 5
            if (luaranFilewb5OptionValue == fileSelect.value) {
                document.getElementById("luaran_file_select_wb5").style.display = "block";
            } else {
                document.getElementById("luaran_file_select_wb5").style.display = "none";
            }
            if (luaranUrlwb3OptionValue == fileSelect.value) {
                document.getElementById("luaran_url_select_wb5").style.display = "block";
            } else {
                document.getElementById("luaran_url_select_wb5").style.display = "none";
            }
    ...
    var uploadFieldLuaranwb5 = document.getElementById("wb5");
    ...
    uploadFieldLuaranwb4.onchange = function() {
        if (this.files[0].size > 5242880) {
            Swal.fire({
                icon: 'error',
                title: 'Mohon Maaf Anda Melebihi Batas Unggah File',
    ...
    uploadFieldLuaranwb5.onchange = function() {
        if (this.files[0].size > 5242880) {
            Swal.fire({
                icon: 'error',
                title: 'Mohon Maaf Anda Melebihi Batas Unggah File',
