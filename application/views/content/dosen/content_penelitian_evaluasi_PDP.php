                    ...
                    <div class="row">
                        <div class="div-table w-100">
                            <div class="table">
                                ...
                                <div class="tr">
                                    <div class="td">2</div>
                                    <div class="td">Artikel di jurnal nasional terakreditasi minimal SINTA 3 atau 4 dengan status minimal submitted</div>
                                    <div class="td">
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#w_b2">
                                            Laporkan
                                        ...
                                        <div class="modal fade" id="w_b2" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Artikel di jurnal nasional terakreditasi minimal SINTA 3 atau 4 dengan status minimal submitted</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
