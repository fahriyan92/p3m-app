...
<input type="hidden" name="id_list_event" value="<?=$id_list_event?>">
                    ...
                    <form id="formnya" method="post" enctype="multipart/form-data">
                        <div class="tab">
                            <div class="row">
                                ...
                                <?php else:  ?>
                                    <input type="hidden" name="id_pengajuan_detail" value="">
                                <?php endif; ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->tema : 'Tema Testing' ?>" class="form-control" placeholder="Tema Penelitian" name="tema_penelitian">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">5. Sasaran Mitra (Jika Ada)</label>
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->sasaran !== "null" ? $dt_proposal->sasaran : '' : 'Mitra Testing' ?>" class="form-control" id="inputSasaran" placeholder="Sasaran Penelitian" name="sasaran_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->judul : 'Judul Testing' ?>" class="form-control" placeholder="Judul Penelitian" name="judul_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" autocomplete="off" value="<?= empty($dt_proposal) !== true ? $dt_proposal->identitas_tkt : '3' ?>" min="0" max="9" class="form-control" id="identitas_tkt" placeholder="1 - 9" name="identitas_tkt" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="qweqweqwe" class="form-control" id="ringkasan" name="ringkasan" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->ringkasan : 'Testing' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="qweqweqwe" class="form-control" id="tinjauan" name="tinjauan" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->tinjauan : 'Testing' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="qweqweqweqwe" class="form-control" id="ringkasan" name="metode" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->metode : 'Testing' ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="number" class="form-control" value="<?= $dosen['ketua'][0]->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 129" name="id_sinta" readonly>
                                                </div>
                                    ...
                                    <?php if (isset($lanjut_dosen) && isset($lanjut_dosen['ketua'])) : ?>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_cv/') . $dosen['ketua'][0]->file_cv ?>" target="_blank"><?= $dosen['ketua'][0]->file_cv  ?></a></h5>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                ...
                                                <?php if (isset($lanjut_dosen) && count($lanjut_dosen['anggota']) > 0) : ?>
                                                    ...
                                                    <input style="margin-left:5px;" disabled type="checkbox" <?= isset($lanjut_dosen['anggota']) ? count($lanjut_dosen['anggota']) === 1 && $lanjut_dosen['anggota'][0]->status_notifikasi == 1 ? 'disabled' : '' : '' ?> name="pakegak">
                                                    <?php else : ?>
