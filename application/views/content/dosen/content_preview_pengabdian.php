                                                                                ...
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <form method="post" action="<?php echo form_open_multipart('C_monitoring_pengabdian_dosen/preview'); ?>">

                                                                                                <div class="form-group">

                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Masukkan Prosentase Laporan : </h5>
                                                                                                    <select class="form-control select2 nm_dosen" style="width: 100%;" name="targetLuaran">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Masukkan Prosentase Laporan : </h5>
                                                                                                    <input type="text" class="form-control" name='prosentase' aria-describedby="emailHelp" placeholder="Masukkan Prosentase">
                                                                                                </div>
                                                                                                <div class="form-group">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input name="fileLaporan" type="file" class="file" data-show-preview="false">
                                                                                                </div>
