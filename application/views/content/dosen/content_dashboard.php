            ...
            <a href="<?= base_url("C_penelitian_dsn_pnbp") ?>">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text text-dark">Penelitian Dosen</span>
                  <span class="info-box-number text-dark">PNBP</span>
                </div>
                <!-- /.info-box-content -->
              </div>
            </a>
          ...
          <?php else: ?>
            ...
            <a href="<?= base_url("C_penelitian_plp_pnbp") ?>">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text text-dark">Penelitian PLP</span>
                  <span class="info-box-number text-dark">PNBP</span>
                </div>
                <!-- /.info-box-content -->
              </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <a href="<?= base_url("C_pengabdian_dsn_pnbp") ?>">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text text-dark">Pengabdian Dosen</span>
                  <span class="info-box-number text-dark">PNBP</span>
                </div>
                <!-- /.info-box-content -->
              </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <a href="<?= base_url("C_settings_user") ?>">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text text-dark">Pengisian Data Diri</span>
                  <span class="info-box-number text-dark">Dosen / PLP</span>
                </div>
                <!-- /.info-box-content -->
              </div>
            </a>
