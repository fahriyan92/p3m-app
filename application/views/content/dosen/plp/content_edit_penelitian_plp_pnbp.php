                            ...
                            <div class="row">
                                ...
                                if (isset($lanjut_dosen['ketua'])) : ?>
                                    ...
                                    <?php if (isset($lanjut_dosen['anggota'][2])) : ?>
                                        <input type="hidden" name="cv_lama_anggota3" value="<?= $lanjut_dosen['anggota'][2]->nidn ?>?<?= $lanjut_dosen['anggota'][2]->file_cv ?>">
                                    <?php endif; ?>
                                    
                                    <?php if (isset($lanjut_dosen['anggota'][3])) : ?>
                                        <input type="hidden" name="cv_lama_anggota4" value="<?= $lanjut_dosen['anggota'][3]->nidn ?>?<?= $lanjut_dosen['anggota'][3]->file_cv ?>">
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (empty($dt_proposal) == false) : ?>
                                    <input type="hidden" name="id_pengajuan_detail" value="<?= $dt_proposal->id_pengajuan_detail ?>">
                                    <input type="hidden" name="proposal_lama" value="<?= $dt_proposal->proposal ?>">
                                    <input type="hidden" name="rab_lama" value="<?= $dt_proposal->rab ?>">
                                <?php endif; ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="inputJudul">3. Tema</label><br>
                                        <div class="err-tema" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <?php foreach ($tema as $tme) { ?>
                                            <input type="radio" name="tema_penelitian" <?= (empty($dt_proposal) !== true ? strtoupper($tme->nama_tema)  == strtoupper($dt_proposal->tema) ? 'checked' : '' : '') ?> value="<?= $tme->nama_tema ?>">
                                            <span class="text-capitalize" for="tema_penelitian"><?= $tme->nama_tema ?></span><br>
                                        <?php } ?>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= empty($dt_proposal) !== true ? $dt_proposal->tahun_usulan : '' ?>" class="form-control" min="2020" max="2099" step="1" name="tahun_penelitian" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= empty($dt_proposal) !== true ? $dt_proposal->biaya : '' ?>" class="form-control" id="biayadiusulkan" placeholder="100000" name="biaya_diusulkan" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="identitas_tkt">9. TKT</label>
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" class="form-control" id="ringkasan" name="ringkasan" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->ringkasan : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" class="form-control" id="tinjauan" name="tinjauan" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->tinjauan : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <label for="statusTKT">13. Metode (max. 2000 kata)</label>
                                        <div class="err-metode" style="display:none;">
                                            <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                        </div>
                                        <textarea value="" class="form-control" id="ringkasan" name="metode" rows="4"><?= empty($dt_proposal) !== true ? $dt_proposal->metode : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nidn" disabled id="nidn_ketua" value="<?= $lanjut_dosen['ketua'][0]->nidn ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="text" class="form-control" name="nama_dosen" value="<?= $lanjut_dosen['ketua'][0]->nama ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="text" class="form-control" name="jurusan" value="<?= $lanjut_dosen['ketua'][0]->unit ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="text" class="form-control" id="pangkat" name="pangkat[]" value="<?= $lanjut_dosen['ketua'][0]->jenis_job ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="number" class="form-control" value="<?= $lanjut_dosen['ketua'][0]->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta" readonly>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="number" class="form-control" value="<?= $lanjut_dosen['ketua'][0]->scopus ?>" id="scopus1" onkeydown="return event.keyCode !== 69" name="scopus" readonly>
                                            </div>
                                            <div class="err-scopus1" style="display:none;">
                                                <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if (isset($lanjut_dosen) && isset($lanjut_dosen['ketua'])) : ?>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cvketua">File CV Ketua</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="scopus">6. ID-Scopus</label>
                                            <div class="custom-file">
                                                <input type="number" class="form-control" id="scopus2" value="<?= isset($lanjut_dosen) && count($lanjut_dosen['anggota']) > 0 ? $lanjut_dosen['anggota'][0]->scopus : '' ?>" name="id_sinta" readonly>
                                            </div>
                                            <div class="err-scopus2" style="display:none;">
                                                <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label for="pakegak">
                                                    ...
                                                    <input style="margin-left:5px;" type="checkbox" name="pakegak" <?= ($lanjut_dosen == null) ? '' : ((isset($lanjut_dosen['anggota'][1]) && $lanjut_dosen['anggota'][1] != null) ? 'checked' : '' )?>>
                                                </label>
                                            </div>
                                        </div> 
                                        <div class="form-anggota2" style="<?= ($lanjut_dosen == null) ? 'display: none;' : ((isset($lanjut_dosen['anggota'][1]) && $lanjut_dosen['anggota'][1] != null) ? '' : 'display: none;') ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="err-scopus3" style="display:none;">
                                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label for="pakegak3">
                                                        Apakah Ingin Menambahkan Anggota 3?
                                                        <input style="margin-left:5px;" type="checkbox" name="pakegak3" <?= ($lanjut_dosen == null) ? '' : ((isset($lanjut_dosen['anggota'][2]) && $lanjut_dosen['anggota'][2] != null) ? 'checked' : '' )?>>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-anggota3" style="<?= ($lanjut_dosen == null) ? 'display: none;' : ((isset($lanjut_dosen['anggota'][2]) && $lanjut_dosen['anggota'][2] != null) ? '' : 'display: none;') ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nidn">2. NAMA DOSEN</label>
                                                    <div class="">
                                                        <input type="text" disabled class="form-control" id="dsn_nama3" name="dsn_nama3" value="<?= ($lanjut_dosen == null)  ? '' :(isset($lanjut_dosen['anggota'][2]) ? $lanjut_dosen['anggota'][2]->nama : '' )?>">                                               </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nidn">3. Jurusan</label>
                                                    <div class="">
                                                        <input type="text" disabled class="form-control" id="dsn_jurusan3" name="dsn_jurusan3" value="<?= ($lanjut_dosen == null)  ? '' :(isset($lanjut_dosen['anggota'][2]) ? $lanjut_dosen['anggota'][2]->unit : '' )?>">                                               </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="pangkat">4. Pangkat / Jabatan Fungsional</label>
                                                    <div class="custom-file">
                                                        <input type="text" disabled class="form-control ag2" id="dsn_pangkat3" name="dsn_pangkat3" value="<?= ($lanjut_dosen == null)  ? '' :(isset($lanjut_dosen['anggota'][2]) ? $lanjut_dosen['anggota'][2]->jenis_job : '' )?>">                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="scopus">6. ID-Scopus</label>
                                                    <div class="custom-file">
                                                        <input type="number" class="form-control ag2" id="scopus4" value="<?= isset($lanjut_dosen) && count($lanjut_dosen['anggota']) > 2 ? $lanjut_dosen['anggota'][2]->scopus : '' ?>" name="scopus" readonly>
                                                    </div>
                                                    <div class="err-scopus3" style="display:none;">
                                                        <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label for="pakegak4">
                                                        Apakah Ingin Menambahkan Anggota 4?
                                                        <input style="margin-left:5px;" type="checkbox" name="pakegak4" <?= ($lanjut_dosen == null) ? '' : ((isset($lanjut_dosen['anggota'][3]) && $lanjut_dosen['anggota'][3] != null) ? 'checked' : '' )?>>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-anggota4" style="<?= ($lanjut_dosen == null) ? 'display: none;' : ((isset($lanjut_dosen['anggota'][3]) && $lanjut_dosen['anggota'][3] != null) ? '' : 'display: none;') ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nidn">2. NAMA DOSEN</label>
                                                    <div class="">
                                                        <input type="text" disabled class="form-control" id="dsn_nama4" name="dsn_nama4" value="<?= ($lanjut_dosen == null)  ? '' : (isset($lanjut_dosen['anggota'][3]) ? $lanjut_dosen['anggota'][3]->nama : '' )?>">                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nidn">3. Jurusan</label>
                                                    <div class="">
                                                        <input type="text" disabled class="form-control" id="dsn_jurusan4" name="dsn_jurusan4" value="<?= ($lanjut_dosen == null)  ? '' : (isset($lanjut_dosen['anggota'][3]) ? $lanjut_dosen['anggota'][3]->unit : '' )?>">                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="pangkat">4. Pangkat / Jabatan Fungsional</label>
                                                    <div class="custom-file">
                                                        <input type="text" disabled class="form-control ag2" id="dsn_pangkat4" name="dsn_pangkat4" value="<?= ($lanjut_dosen == null)  ? '' : (isset($lanjut_dosen['anggota'][3]) ? $lanjut_dosen['anggota'][3]->jenis_job : '' )?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                ...
                                <?php if (isset($dt_proposal)) : ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_proposal/') . $dt_proposal->proposal ?>" target="_blank"><?= $dt_proposal->proposal ?></a></h5>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile">Unggah File Proposal Lengkap <?= isset($dt_proposal) ? '<span style="color:red;">(Jika tidak ingin mengganti file rab bisa dikosongi)</span>' : '' ?></label>
                                        <div class="form-group">
                                            <div class="custom-file">
                                ...
                                <?php if (isset($dt_proposal)) : ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_rab/') . $dt_proposal->rab ?>" target="_blank"><?= $dt_proposal->rab ?></a></h5>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile">Unggah File RAB <?= isset($dt_proposal) ? '<span style="color:red;">(Jika tidak ingin mengganti file rab bisa dikosongi)</span>' : '' ?></label>
                                        <div class="form-group">
                                            <div class="custom-file">
...
<script src="<?= base_url() . JS_DOSEN; ?>pengajuan_edit_plp_pnbp.js?random=<?= uniqid(); ?>"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var counter = 2;
        const mhs = <?= json_encode($lanjut_mhs) ?>;
        console.log(mhs);
        console.log(mhs.length);

        const tambah_mahasiswa = (data_mhs = null, index = null) => {

            var newSelectDiv = $(document.createElement('div'))
                .attr("id", 'append' + counter);
            let nim_mhs = (data_mhs != null) ? mhs[index].nim : '';
            let nama_mhs = (data_mhs != null) ? mhs[index].nama : '';
            let jurusan_mhs = (data_mhs != null) ? mhs[index].jurusan : '';
            let angkatan_mhs = (data_mhs != null) ? mhs[index].angkatan : '';
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control nim_mhs" id="nim${counter+1}" placeholder="NIM MAHASISWA" name="nimmahasiswa" value="${nim_mhs}">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control nim_mhs" id="jurusan_mhs${counter +1}" placeholder="Jurusan Mahasiswa" name="jurusan_mhs" value="${jurusan_mhs}">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nm_mhs${counter +1}" placeholder="Nama Lengkap" name="nm_mhs" value="${nama_mhs}">
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="angkatan1">Angkatan Mahasiswa ${counter +1}</label>
                                        <input type="text" class="form-control" id="angkatan${counter +1}" placeholder="Angkatan Mahasiswa" name="angkatan" value="${angkatan_mhs}">
                                    </div>
        ...
        if (mhs.length === 1) {
            $('#nim1').val(mhs[0].nim);
            $('#nm_mhs1').val(mhs[0].nama);
            $('#angkatan1').val(`${mhs[0].angkatan}`);
            $('#jurusan_mhs1').val(`${mhs[0].jurusan}`);
        }
        ...
        if (mhs.length === 2) {
            ...
            $('#nim2').val(mhs[1].nim);
            $('#nm_mhs2').val(mhs[1].nama);
            $('#angkatan2').val(`${mhs[1].angkatan}`);
            $('#jurusan_mhs2').val(`${mhs[1].jurusan}`);
        ...
        if (mhs.length > 2) {
            ...
            for (let i = 2; i < mhs.length; i++) {
                tambah_mahasiswa(mhs, i);
            }
...
<?php if (isset($lanjut_dosen)) : ?>
    <script>
        ...
        if (anggota.length === 2) {
            ...
            $('input[name="pakegak"]').prop('disabled', true);
            $('#anggota1').val(anggota[0].nidn).trigger('change');
            if (anggota[0].status_notifikasi == 1) {
                $('#anggota1').prop('disabled', true);
                $('#id_sinta2').prop('disabled', true);
        ...
        if (anggota.length === 3) {
            ...
            // $('input[name="pakegak3"]').prop('disabled', true);
            // $('#anggota2').val(anggota[1].nidn).trigger('change');
            // if (anggota[1].status_notifikasi == 1) {
            //     $('#anggota2').prop('disabled', true);
            //     $('#id_sinta3').prop('disabled', true);
        ...
        if (anggota.length === 4) {
            ...
            // // $('input[name="pakegak4"]').prop('disabled', true);
            // $('#anggota3').val(anggota[2].nidn).trigger('change');
            // if (anggota[2].status_notifikasi == 1) {
            //     $('#anggota3').prop('disabled', true);
            //     $('#id_sinta4').prop('disabled', true);
