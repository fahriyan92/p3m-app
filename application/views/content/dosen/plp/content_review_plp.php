            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control text-capitalize" type="text"
                                    value="<?= $dt_proposal->nama_ketua ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" min="1900" max="2099" step="1"
                                    value="<?= $dt_proposal->tahun_usulan; ?>" id="tahunPenelitianDosenPNBP"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Tema Penelitian"
                                    name="tema_penelitian" value="<?= $dt_proposal->tema; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputJudul">Sasaran Mitra</label>
                                <input type="text" value="<?= $dt_proposal->sasaran; ?>" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="luaran1" name="luaran[]" <?=((in_array($lr->id_luaran,
                                    $luaran_checked) ? 'checked' : 'disabled')) ?> value="<?= $lr->id_luaran ?>">
                                    <span for="luaran1">
                                        <?= $lr->judul_luaran ?>
                                    </span><br>
                                    <?php endif; ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <br>
                        <a href="<?= base_url('assets/berkas/file_proposal/') . $dt_proposal->proposal ?>"
                            target="_blank">File Proposal</a> |
                        <a href="<?= base_url('assets/berkas/file_rab/') . $dt_proposal->rab ?>" target="_blank">File
                            RAB</a>
                    </div>
                    <?php endif; ?>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <input type="button" class="btn btn-primary btn-dosen" value="Lihat PLP Terdaftar">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 anggota-dosen" style="display: none;">
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title">List Anggota PLP </h3>
                                </div>
