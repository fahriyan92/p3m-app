                    ...
                    <div class="row">
                        <div class="div-table w-100">
                            <div class="table">
                                ...
                                <div class="tr">
                                    <div class="td">2</div>
                                    <div class="td">Satu produk paten sederhana atau paten dengan status terdaftar</div>
                                    <div class="td">
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#w_b2">
                                            Laporkan
                                        ...
                                        <div class="modal fade" id="w_b2" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Satu produk paten sederhana atau paten dengan status terdaftar</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                ...
                                <div class="tr">
                                    <div class="td">3</div>
                                    <div class="td">Satu dokumen kerjasama dengan industri yang menerangkan bahwa teknologi, metode atau ipteks yang diterapkembangkan digunakan oleh industri dalam jangka waktu minimal 1 tahun</div>
                                    <div class="td">
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#w_b3">
                                            Laporkan
                                        ...
                                        <div class="modal fade" id="w_b3" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Satu dokumen kerjasama dengan industri yang menerangkan bahwa teknologi, metode atau ipteks yang diterapkembangkan digunakan oleh industri dalam jangka waktu minimal 1 tahun
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
