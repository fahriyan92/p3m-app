...
<?php if($pemonev !== NULL) : ?>
			...
			<div class="div-table w-100">
			  <div class="table">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
					 ...
					 <div class="tr">
						...
						<div class="td">
								<input disabled name="tambahan5_bobot" type="number" class="form-control form-control-sm" id="tambahan5_bobot" min="1" max="100" value="<?php if (!empty($laporan_monev->komponen_bobot_tambahan5)) : ?><?= $laporan_monev->komponen_bobot_tambahan5; ?><?php endif ?>">
						</div>
						<div class="td">
							<input disabled name="tambahan5_skor" type="number" class="form-control form-control-sm" id="tambahan5_skor" min="1" max="7" value="<?php if (!empty($laporan_monev->komponen_skor_tambahan5)) : ?><?= $laporan_monev->komponen_skor_tambahan5; ?><?php endif ?>">
						</div>
						<div class="td">
					...
					<div class="tr">
					 ...
					 <div class="td">
							 <input disabled name="tambahan6_bobot" type="number" class="form-control form-control-sm" id="tambahan6_bobot" min="1" max="100" value="<?php if (!empty($laporan_monev->komponen_bobot_tambahan6)) : ?><?= $laporan_monev->komponen_bobot_tambahan6; ?><?php endif ?>">
					 </div>
					 <div class="td">
						 <input disabled name="tambahan6_skor" type="number" class="form-control form-control-sm" id="tambahan6_skor" min="1" max="7" value="<?php if (!empty($laporan_monev->komponen_skor_tambahan6)) : ?><?= $laporan_monev->komponen_skor_tambahan6; ?><?php endif ?>">
					 </div>
					 <div class="td">
				 ...
				 <div class="tr">
					...
					<div class="td">
							<input disabled name="tambahan7_bobot" type="number" class="form-control form-control-sm" id="tambahan7_bobot" min="1" max="100" value="<?php if (!empty($laporan_monev->komponen_bobot_tambahan7)) : ?><?= $laporan_monev->komponen_bobot_tambahan7; ?><?php endif ?>">
					</div>
					<div class="td">
						<input disabled name="tambahan7_skor" type="number" class="form-control form-control-sm" id="tambahan7_skor" min="1" max="7" value="<?php if (!empty($laporan_monev->komponen_skor_tambahan7)) : ?><?= $laporan_monev->komponen_skor_tambahan7; ?><?php endif ?>">
					</div>
					<div class="td">
				...
				<div class="tr">
				 ...
				 <div class="td">
						 <input disabled name="tambahan8_bobot" type="number" class="form-control form-control-sm" id="tambahan8_bobot" min="1" max="100" value="<?php if (!empty($laporan_monev->komponen_bobot_tambahan8)) : ?><?= $laporan_monev->komponen_bobot_tambahan8; ?><?php endif ?>">
				 </div>
				 <div class="td">
					 <input disabled name="tambahan8_skor" type="number" class="form-control form-control-sm" id="tambahan8_skor" min="1" max="7" value="<?php if (!empty($laporan_monev->komponen_skor_tambahan8)) : ?><?= $laporan_monev->komponen_skor_tambahan8; ?><?php endif ?>">
				 </div>
				 <div class="td">
    ...
    <a target="_blank" href="<?= base_url("pdfexport/ptm/" . $idproposal . '/' . $idevents); ?>"><button type="button" class="btn btn-success">Export PDF</button></a>
	<?php else : ?>
