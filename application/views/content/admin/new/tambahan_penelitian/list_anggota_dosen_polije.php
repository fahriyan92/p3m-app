        ...
        <?php if (!empty($list_dosen)) : ?>
            <?php 
                ...
                <tr>
                    ...
                    <?php if($jenis == "temp") : ?>
                        <td><a href="<?= site_url('C_tambahan_penelitian/delete_temp/'.$key->nidn.'/'.$key->id_list_event) ?>" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-trash"></i></a>
                    <?php else: ?>
                        <td><a href="<?= site_url('C_tambahan_penelitian/delete_not_temp/'.$key->nidn.'/'.$key->id_pengajuan_detail) ?>" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-trash"></i></a>
                    <?php endif; ?>
...
$( document ).ready(function() {
    $('#table_list_anggota_dosen_polije').DataTable();
});
