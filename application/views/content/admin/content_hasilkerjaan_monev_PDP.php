...
<?php if($pemonev !== NULL) : ?>
			...
			<div class="div-table w-100">
			  <div class="table">
			    ...
			    <div class="tr">
			      <div class="td">2</div>
			      <div class="td">
							Artikel di jurnal nasional terakreditasi minimal SINTA 3 atau 4 dengan status minimal submitted
			      </div>
			      <div class="td">
							<div class="td">
    ...
    <a target="_blank" href="<?= base_url("pdfexport/pdp/" . $idproposal . '/' . $idevents); ?>"><button type="button" class="btn btn-success">Export PDF</button></a>
	<?php else : ?>
