        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" value="<?= isset($identitas) ? set_value('nip') == true ? set_value('nip') : $identitas->judul : set_value('nip') ?>" class="form-control" placeholder="NIP" name="nip">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" value="<?= isset($identitas) ? set_value('nama') == true ? set_value('nama') : $identitas->judul : set_value('nama') ?>" class="form-control" placeholder="Nama Lengkap" name="nama">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="email" autocomplete="off" value="<?= isset($identitas) ? set_value('email') == true ? set_value('email') : $identitas->judul : set_value('email') ?>" class="form-control" placeholder="Email" name="email">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="inputJudul">4. JENIS USER</label>
                            <div class="err-judul" style="display:none;">
                                <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                            </div>
