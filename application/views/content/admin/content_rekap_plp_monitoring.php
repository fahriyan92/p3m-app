                ...
                <div class="card-default">
                    <div class="card-header">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link jenis-event active" href="6" data-list="6" style="display: none">Belum diproses</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event" href="#" data-list="7" style="margin-left: 5px; display: none">Lolos Monev</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event " href="#" data-list="8" style="margin-left: 5px; display: none">Tidak Lolos Monev</a>
                            </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="judul_proposal">
...
<script src="<?= base_url() . JS_UMUM; ?>staff_rekap_plp_monitoring.js?random=<?= uniqid(); ?>"></script>
