...
<?php if($pemonev !== NULL) : ?>
			...
			<div class="div-table w-100">
			  <div class="table">
			    ...
			    <div class="tr">
			      <div class="td">1</div>
			      <div class="td">
			      	Seminar laporan hasil penelitian dalam pertemuan ilmiah di tingkat institusi,  nasional atau internasional (bukti fisik berupa berita acara); atau Publikasi artikel ilmiah yang diterbitkan dalam jurnal ilmiah (minimal submit).
			      </div>
			      <div class="td">
    ...
    <a target="_blank" href="<?= base_url("pdfexport/plp/" . $idproposal . '/' . $idevents); ?>"><button type="button" class="btn btn-success">Export PDF</button></a>
	<?php else : ?>
