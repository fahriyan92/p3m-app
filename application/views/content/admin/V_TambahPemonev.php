...
<script src="<?= base_url() . JS_UMUM; ?>dummy_tambahPemonev.js?random=<?= uniqid(); ?>"></script>
                        ...
                        <?php if (!empty($dtl_proposal)) : ?>
                            ...
                            <?php if ($rekap != true) : ?>
                                <?php if ($this->session->userdata('level') != 4) : ?>
                                    ...
                                    <?php if ($dtl_proposal->status_keputusan != null && $dtl_proposal->status_keputusan == 3 ||$dtl_proposal->status_keputusan == 1 || $dtl_proposal->status_keputusan == 2 || $dtl_proposal->status_keputusan == 6) : ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if ($check_event_review != null) : ?>
                                                    ...
                                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="float: right;">Tambah Pemonev</a>
                                                <?php else : ?>
                                                    <a href="javascript:void(0)" class="btn btn-danger" style="float: right;">Event Monev Masih Di Tutup</a>
                                                <?php endif; ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php if ($re['nilai_fix'] == "Belum Review") : ?>
                                                                                    <a href="<?= base_url("C_Pemonev/hapusPemonev/") . $re['id_kerjaan']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>

                                                                                <?php endif ?>

                                                                                <a href="<?= base_url("C_Pemonev/hasil_kerjaan_pemonev/") . $re['id_kerjaan']; ?>/<?= $dtl_proposal->id_event ?>" class="btn btn-sm btn-primary">lihat review</a>
                                                                            </td>
...
<div class="modal fade" id="myModal" role="dialog" style="overflow:hidden;">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php $idproposal = $this->uri->segment('6'); ?>
