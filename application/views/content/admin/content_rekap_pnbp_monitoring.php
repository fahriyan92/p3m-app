                ...
                <div class="card-default">
                    <div class="card-header">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link jenis-event active" href="#" data-list="6" style="display: none">Belum diproses</a>
                            </li>
                            <li class="nav-item">
...
<script src="<?= base_url() . JS_UMUM; ?>staff_rekap_pnbp_monitoring.js?random=<?= uniqid(); ?>"></script>
