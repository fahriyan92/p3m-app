        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-default">
                    <div class="card-header">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link jenis-event active" href="#" data-list="0">Penelitian Dosen</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event" href="#" data-list="1" style="margin-left: 5px;">Pengabdian</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event " href="#" data-list="2" style="margin-left: 5px;">Penelitian PLP</a>
                            </li>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="text-center mb-3 judulnya"></h5>
                            <div class="row mb-5">
...
<script src="<?= base_url() . JS_UMUM; ?>monitoringAdmin.js?random=<?= uniqid(); ?>"></script>