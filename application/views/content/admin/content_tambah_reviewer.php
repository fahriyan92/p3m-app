                        ...
                        <?php if (!empty($dtl_proposal)) : ?>
							...
							<div class="row">
								<div class="col-md-6 mt-3">
									<label>File Evaluasi</label>
									<br>
									<?php if (isset($berkas_eval_penelitian)) : ?>
										<a href="<?= base_url('assets/berkas/file_laporan/penelitian/') . $berkas_eval_penelitian->b_laporan_akhir ?>" target="_blank">File Laporan Akhir</a> |
										<a href="<?= base_url('assets/berkas/file_laporan/penelitian/') . $berkas_eval_penelitian->b_laporan_keuangan ?>" target="_blank">File Keuangan</a>
									<?php elseif (isset($berkas_eval_pengabdian)) : ?>
										<a href="<?= base_url('assets/berkas/file_laporan/pengabdian/') . $berkas_eval_pengabdian->b_laporan_akhir ?>" target="_blank">File Laporan Akhir</a> |
										<a href="<?= base_url('assets/berkas/file_laporan/pengabdian/') . $berkas_eval_pengabdian->b_laporan_keuangan ?>" target="_blank">File Keuangan</a>
									<?php else : ?>
									Tidak Ada File Yang Diunggah oleh Pengguna
									<?php endif ?>
								</div>
							</div>
                            ...
                            <?php if ($rekap != true) : ?>
                                <?php if ($this->session->userdata('level') != 4) : ?>
                                    ...
                                    <?php if ($dtl_proposal->status_keputusan != null && $dtl_proposal->status_keputusan == 3 ||$dtl_proposal->status_keputusan == 1 || $dtl_proposal->status_keputusan == 2) : ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <?php else : ?>
                                                    <a href="javascript:void(0)" class="btn btn-danger" style="float: right;">Event Review Masih Di Tutup</a>
                                                <?php endif; ?>
                                                            ...
                                                            <tbody><?php if (!empty($reviewer)) : $no = 1; ?>
                                                                    <?php foreach ($reviewer->result_array() as $re) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?= $re['nilai_fix'] ?></td>
                                                                            <td>
                                                                                <?php if ($re['nilai_fix'] == "Belum Review") : ?>
                                    ...
                                    <?php elseif ($dtl_proposal->status_keputusan == 6) : ?>
                                        <h1 class="text-center"> LANJUT KE TAHAP PEMONEV</h1>

                                    <?php elseif ($dtl_proposal->status_keputusan == 7) : ?>
                                        <h1 class="text-center"> LOLOS MONEV</h1>
                                    ...
                                    <?php else : ?>
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <a href="#" class="btn btn-success tombol-terima" data-tmbl="lanjut_review" style="float: left; width:inherit;">Lanjut Ke Tahap Review</a>
                                                </div>
                                                <div class="col-md-6">
                                                    <a href="#" class="btn btn-danger tombol-tolak" data-tmbl="tolak_administrasi" style="float: right; width:inherit;">Tidak Lolos Administrasi</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif ?>
