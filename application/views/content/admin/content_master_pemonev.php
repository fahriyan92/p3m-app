                ...
                <div class="col-md-4">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title title_form"><span class="mode-form">Tambah</span> Pemonev</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="reviewerMaster">Nama Pemonev</label>
                                                    <div id="add">
                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="table-responsive mb-5 text-nowrap">
                                <h3 class="card-title text-center">Master Pemonev<span class="titel-thn"></span></h3>

                                <table id="tabelmasterrvw" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th class="text-center" width="5%">No.</th>
                                            <th class="text-center" width="40%">Nama Pemonev</th>
...
<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'master_pemonev.js?' . 'random=' . uniqid() ?> "></script>
