              ...
              <div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										<th scope="row">2</th>
										<td>Artikel di jurnal nasional terakreditasi minimal SINTA 3 atau 4 dengan status minimal submitted </td>
							...
							<div class="form-group my-4">
								<textarea readonly class="form-control" id="masukan" name="masukan" rows="4" placeholder="Ketik Masukan Disini" required><?php if (isset($masukan->masukan_evaluasi)) : ?><?= $masukan->masukan_evaluasi ?><?php else : ?><?php endif; ?></textarea>
							</div>
						</div>
</div>