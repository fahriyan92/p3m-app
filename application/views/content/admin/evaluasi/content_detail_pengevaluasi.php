            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($dtl_proposal->status_keputusan != null && $dtl_proposal->status_keputusan == 6 || $dtl_proposal->status_keputusan == 7 || $dtl_proposal->status_keputusan == 9) : ?>

                        <!-- /.row -->
                        <div class="row">
                            <div class="col-md-8">
                                <h6 style="font-weight: bold;">Evaluasi Yang Ditunjuk</h6>
                            </div>
                            <div class="col-md-4">
                                <?php if ($check_event_review != null) : ?>
                                <?php else : ?>
                                <a href="javascript:void(0)" class="btn btn-danger" style="float: right;">Event Evaluasi Masih Di Tutup</a>
                                <?php endif; ?>
                                    ...
                                    <table id="table-reviewe-list" class="table table-bordered table-striped">
                                        ...
                                        <tbody><?php if (!empty($reviewer)) : $no = 1; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $re['unit'] ?></td>
                                                <td>
                                                    <a href="<?= base_url("C_evaluasi/hasil_kerjaan_pengevaluasi/") . $re['id_kerjaan_evaluasi']; ?>/<?= $dtl_proposal->id_event ?>"
                                                        class="btn btn-sm btn-primary">Lihat Evaluasi</a>
                                                </td>
                        ...
                        <?php elseif ($dtl_proposal->status_keputusan == 10) : ?>
                        <h1 class="text-center"> LOLOS EVALUASI</h1>

                        <?php elseif ($dtl_proposal->status_keputusan == 11) : ?>
                        <h1 class="text-center"> TIDAK LOLOS EVALUASI</h1>
