                ...
                <div class="card-default">
                    <div class="card-header">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link jenis-event active" href="6" data-list="9">Belum diproses</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event" href="#" data-list="11" style="margin-left: 5px;">Lolos Evaluasi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link jenis-event " href="#" data-list="12" style="margin-left: 5px;">Tidak Lolos Evaluasi</a>
                            </li>
