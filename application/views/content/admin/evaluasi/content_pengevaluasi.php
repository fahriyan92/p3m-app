            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-pills p-2">
                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active jenis_proses" href="#tab_1" data-list="proses" data-toggle="tab">Proses seleksi dan pembagian Pengevaluasi</a></li>
...
<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'evaluasi/staff_pengevaluasi.js?' . 'random=' . uniqid() ?> "></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#removeButton").click(function() {
            if (counter == 3) {
                alert("Batas minimum jumlah pemonev tercapai!");
                return false;
            }
