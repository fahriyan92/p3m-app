            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-pills p-2">
                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active jenis_proses" href="#tab_1" data-list="proses" data-toggle="tab">Proses seleksi dan pembagian pemonev</a></li>
...
<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'staff_pemonev.js?' . 'random=' . uniqid() ?> "></script>
