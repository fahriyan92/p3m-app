            ...
            <form action="">
                ...
                <div class="modal-body">
                    <div class="row" id="hide">
                        <div class="col-sm-10">
                            <div class="form-group">
                                <label for="fokusedit">Judul Fokus</label>
                                <input type="text" class="form-control" id="fokusedit" placeholder="Fokus Penelitian" name="fokusedit" required="" value="asdasdasd">
                            </div>
                            <div class="error-fokus" style="display:none;">
                                <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                            </div>
