        ...
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <form
                        action="<?= $status->status == 0 ? base_url("C_evaluasi/submitEvaluasi/$idproposal") : base_url("C_evaluasi/editEvaluasi/$idproposal") ?>"
                        method="POST">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>Satu artikel ilmiah (ICoFA atau ICoSHIP, atau publisher bereputasi lainnya,
                                            atau seminar internasional yang lain bila tidak lolos seleksi pada publisher
                                            prosiding ICoFA atau ICoSHIP</td>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->w_b1 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen1"
                                                    id="sesuaiLuaran1" value="sesuai luaran" required>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen1"
                                                    id="tidakSesuaiLuaran1" value="tidak sesuai">
                                    ...
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>Satu artikel di Jurnal Internasional yang terindeks pada database
                                            bereputasi; atau di Jurnal Internasional; atau jurnal nasional terakreditasi
                                            SINTA 1-2 dengan status minimal terdaftar (submitted) </td>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->w_b2 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <?php endif; ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen2"
                                                    id="sesuaiLuaran2" value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen2"
                                                    id="tidakSesuaiLuaran2" value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                            </div>
                                    ...
                                    <tr>
                                        <th scope="row">3</th>
                                        <td>Satu Paten atau Paten Sederhana atau Perlindungan Varietas Tanaman atau
                                            Desain Tata Letak Sirkuit Terpadu atau naskah kebijakan dengan status
                                            minimal terdaftar.</td>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->w_b3 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <?php endif; ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen3"
                                                    id="sesuaiLuaran3" value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen3"
                                                    id="tidakSesuaiLuaran3" value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                            </div>
                                    ...
                                    <tr>
                                        <th scope="row">4</th>
                                        <td>Satu Kekayaan Intelektual berupa Hak Cipta dengan status Granted atas nama
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->w_b4 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <?php endif; ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen4"
                                                    id="sesuaiLuaran4" value="sesuai luaran">
                                                <label class="form-check-label" for="sesuaiLuaran" required>
                                                    Sesuai Luaran
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen4"
                                                    id="tidakSesuaiLuaran4" value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b1 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan1" id="sesuaiLuaranTambahan1"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan1" id="tidakSesuaiLuaranTambahan1"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b2 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan2" id="sesuaiLuaranTambahan2"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan2" id="tidakSesuaiLuaranTambahan2"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b3 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan3" id="sesuaiLuaranTambahan3"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan3" id="tidakSesuaiLuaranTambahan3"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b4 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan4" id="sesuaiLuaranTambahan4"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan4" id="tidakSesuaiLuaranTambahan4"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b5 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan5" id="sesuaiLuaranTambahan5"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan5" id="tidakSesuaiLuaranTambahan5"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b6 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan6" id="sesuaiLuaranTambahan6"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan6" id="tidakSesuaiLuaranTambahan6"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b7 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan7" id="sesuaiLuaranTambahan7"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan7" id="tidakSesuaiLuaranTambahan7"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url("assets/berkas/file_laporan/penelitian/") . $berkas->t_b8 ?>"
                                                target="_blank">Unduh</a></td>
                                        <?php else: ?>
                                        <td>Tidak Ada File</td>
                                        <?php endif; ?>
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan8" id="sesuaiLuaranTambahan8"
                                                    value="sesuai luaran" required>
                                                <label class="form-check-label" for="sesuaiLuaran">
                                                    Sesuai Luaran
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="kesimpulan_komponen_tambahan8" id="tidakSesuaiLuaranTambahan8"
                                                    value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
