                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php endif; ?>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen4" id="sesuaiLuaran4" value="sesuai luaran">
                                                <label class="form-check-label" for="sesuaiLuaran" required>
                                                    Sesuai Luaran
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kesimpulan_komponen4" id="tidakSesuaiLuaran4" value="tidak sesuai">
                                                <label class="form-check-label" for="tidakSesuaiLuaran">
                                                    Tidak Sesuai Luaran
                                                </label>
                                            </div>
