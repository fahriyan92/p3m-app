          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      ...
                      <input readonly type="text" class="form-control" id="inputJudul" placeholder="Judul Penelitian" value="<?= $dt_proposal->judul; ?>" name="judulPenelitianDosenPNBP" >
                  </div>
              </div>
          </div>
          <?php endif; ?>
          <div class="row">
              ...
              <div class="col-sm-6">
                  <div class="form-group">
                      ...
                      <input readonly type="text" class="form-control" id="biayadiusulkan" value="<?= rupiah($dt_proposal->biaya_usulan); ?>" placeholder="Rp.8.500.000,-" name="biayadiusulkan" >
                  </div>
              </div>
            </div>
            <div class="row">
                <div class="col-sm-5">
                  <div class="form-group">
                      ...
                      <input readonly type="date" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" id="tglmulai" placeholder="mulai" name="tglmulai" value="<?= $dt_proposal->mulai; ?>" >
                  </div>
                </div>
                ...
                <div class="col-sm-5">
                  <div class="form-group">
                      ...
                      <input readonly type="date" class="form-control" id="tglakhir" data-inputmask-inputformat="dd/mm/yyyy" placeholder="akhir" name="tglakhir" value="<?= $dt_proposal->akhir; ?>" >
                  </div>
                </div>
              </div>
<form id="pkln" name="pkln" method="post" action="<?= $status->status == 0 ? base_url("C_monitoring/simpan_monev_pvuj/") : base_url("C_monitoring/edit_monev_pvuj/") ?>">
	<div class="row">
			  ...
			  <div class="table">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
						...
						<div class="td">
								<input readonly name="ket1_bobot" type="number" class="form-control form-control-sm" id="ket1_bobot" min="30" max="30" value="30">
			      </div>
						<div class="td">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
				      ...
				      <div class="td">
							...
							<div class="td text-center">
								<input readonly name="ket3_bobot" type="number" class="form-control form-control-sm" id="ket3_bobot" min="20" max="20" value="20">
				      </div>
							<div class="td">
					      ...
					      <div class="td">
								...
								<?php else : ?>
									<select  name="keterangan4" class="form-control form-control-sm" aria-label="keterangan3">
										<option value="Tidak ada">Tidak ada</option>
 									 <option value="Draft">Draft</option>
 									 <option value="Terdaftar">Terdaftar</option>
 									 <option value="Granted">Granted</option>
	...
	<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'jumlah_total_content_penelitian_PVUJ.js?' . 'random=' . uniqid() ?> "></script>
