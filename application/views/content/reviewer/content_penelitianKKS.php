...
<form id="pkln" name="pkln" method="post" action="<?= $status->status == 0 ? base_url("C_monitoring/simpan_monev_kks/") : base_url("C_monitoring/edit_monev_kks/") ?>">
	<div class="row">
	...
	<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'jumlah_total_content_penelitian_KKS.js?' . 'random=' . uniqid() ?> "></script>
