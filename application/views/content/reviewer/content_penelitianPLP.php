...
<form id="pkln" name="pkln" method="post" action="<?= $status->status == 0 ? base_url("C_monitoring/simpan_monev_plp/") : base_url("C_monitoring/edit_monev_plp/") ?>">
	<div class="row">
			  ...
			  <div class="table">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
						...
						<div class="td">
								<input readonly name="ket1_bobot" type="number" name="ket1_bobot" onkeyup="penjumlahan" class="form-control form-control-sm" id="ket1_bobot" min="100" max="100" value="100">
			      </div>
						<div class="td">
	...
	<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'jumlah_total_content_penelitian_PLP.js?' . 'random=' . uniqid() ?> "></script>
