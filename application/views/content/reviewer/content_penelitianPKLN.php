...
<form id="pkln" name="pkln" method="post" action="<?= $status->status == 0 ? base_url("C_monitoring/simpan_monev_pkln/") : base_url("C_monitoring/edit_monev_pkln/") ?>">
	<div class="row">
			  ...
			  <div class="table">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
						...
						<div class="td">
								<input readonly name="ket1_bobot" type="number" name="ket1_bobot" onkeyup="penjumlahan" class="form-control form-control-sm" id="ket1_bobot" min="30" max="30" value="30">
			      </div>
						<div class="td">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
						...
						<div class="td text-center">
							<input readonly name="ket2_bobot" type="number" class="form-control form-control-sm" id="ket2_bobot" min="40" max="40" value="40">
			      </div>
						<div class="td">
...
<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'content_penelitian_pemonev.js?' . 'random=' . uniqid() ?> "></script>
	<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'jumlah_total_content_penelitian_PKLN.js?' . 'random=' . uniqid() ?> "></script>
