          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="inputJudul" placeholder="Judul Penelitian" value="<?= $dt_proposal->judul; ?>" name="judulPenelitianDosenPNBP" readonly>
                  </div>
              </div>
          </div>
          <?php endif; ?>
          <div class="row">
              ...
              <div class="col-sm-6">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="biayadiusulkan" value="<?= rupiah($dt_proposal->biaya_usulan); ?>" placeholder="Rp.8.500.000,-" name="biayadiusulkan" readonly>
                  </div>
              </div>
            </div>
            <div class="row">
                <div class="col-sm-5">
                  <div class="form-group">
                      ...
                      <input type="date" class="form-control" data-inputmask-inputformat="dd/mm/yyyy" id="tglmulai" placeholder="mulai" name="tglmulai" value="<?= $dt_proposal->mulai; ?>" readonly>
                  </div>
                </div>
                ...
                <div class="col-sm-5">
                  <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="tglakhir" data-inputmask-inputformat="dd/mm/yyyy" placeholder="akhir" name="tglakhir" value="<?= $dt_proposal->akhir; ?>" readonly>
                  </div>
                </div>
              </div>
<form id="pkln" name="pkln" method="post" action="<?= $status->status == 0 ? base_url("C_monitoring/simpan_monev_ptm/") : base_url("C_monitoring/edit_monev_ptm/") ?>">
	<div class="row">
			  ...
			  <div class="table">
			    ...
			    <div class="tr">
			      ...
			      <div class="td">
						...
						<div class="td">
								<input readonly name="ket1_bobot" type="number" name="ket1_bobot" onkeyup="penjumlahan" class="form-control form-control-sm" id="ket1_bobot" min="20" max="20" value="20">
			      </div>
						<div class="td">
			    ...
			    <div class="tr">
			      <div class="td">2</div>
			      <div class="td">
							Satu artikel yang dimuat dalam jurnal ilmiah nasional terakreditasi peringkat 1-2 atau satu artikel di jurnal internasional dengan status minimal submitted sebagai penulis pertama adalah mahasiswa yang dibimbing dan ketua peneliti sebagai corresponding author			      </div>
			      <div class="td">
							<div class="td">
								<?php if($status->status == 1) : ?>
						...
						<div class="td text-center">
							<input readonly name="ket2_bobot" type="number" class="form-control form-control-sm" id="ket2_bobot" min="30" max="30" value="30">
			      </div>
						<div class="td">
				      ...
				      <div class="td">3</div>
				      <div class="td">
								Satu artikel jurnal ilmiah nasional terakreditasi peringkat 1-2 / satu artikel di jurnal internasional status submitted sebagai penulis pertama dan  corresponding author adalah ketua peneliti
							</div>
				      <div class="td">
								<?php if($status->status == 1) : ?>
							...
							<div class="td text-center">
								<input readonly name="ket3_bobot" type="number" class="form-control form-control-sm" id="ket3_bobot" min="30" max="30" value="30">
				      </div>
							<div class="td">
					      ...
					      <div class="td">
								...
								<div class="td text-center">
									<input readonly name="ket4_bobot" type="number" class="form-control form-control-sm" id="ket4_bobot" min="20" max="20" value="20">
					      </div>
								<div class="td">
			    					<input name="ket4_skor" type="number" class="form-control form-control-sm" id="ket4_skor" min="0" max="7" value="<?php if (!empty($laporan_monev->komponen_skor4)) : ?><?= $laporan_monev->komponen_skor4; ?><?php endif ?>">
					      </div>
								<div class="td">
	...
	<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'jumlah_total_content_penelitian_PTM.js?' . 'random=' . uniqid() ?> "></script>
