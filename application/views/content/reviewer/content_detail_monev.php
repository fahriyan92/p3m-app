                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($dt_proposal)) : ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <a href="<?= base_url("C_monitoring/monev_proposal/") ?><?= $status->id_kerjaan_monev ?>/<?= $dt_proposal->id_event ?>" class="btn btn-primary" style="float:right;"> <i class="fa fa-paste"></i> <?= $status->status == 0  ? 'Monev Proposal' : 'Lihat Penilaian' ?></a>
                            </div>
