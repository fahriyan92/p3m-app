          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item has-treeview <?= $url === 'C_rekap' || $url === 'C_reviewer' && $url2 !== "dsnReviewer" && $url2 !== "proposalReviewer" ? 'menu-open' : '' ?>">
                      <a href="" class="nav-link <?= $url === 'C_rekap' || $url === 'C_reviewer' && $url2 !== "dsnReviewer" && $url2 !== "proposalReviewer" ? 'active' : '' ?>">
                  ...
                  <li class="nav-item has-treeview <?= $url === 'C_master_data' ? 'menu-open' : '' ?>">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="<?= base_url("C_master_data") ?>" class="nav-link <?= $url === 'C_master_data' && $url2 !== "fokus" && $url2 !== "luaran" && $url2 !== 'jenis_proposal' && $url2 !== 'reviewer' ? 'active' : '' ?>">
