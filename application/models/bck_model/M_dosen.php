...
class M_dosen extends CI_Model
{
	...
	public function check_tipe_pengajuan($id)
	{
		...
		$sql = "SELECT c.id_event FROM tb_pengajuan_detail as a JOIN tb_pengajuan as aa ON aa.id_pengajuan = a.id_pengajuan JOIN tb_list_event as b ON aa.id_list_event=b.id_list_event JOIN tb_jenis_event c on b.id_jenis_event = c.id_jenis_event WHERE a.id_pengajuan_detail = ".$id ;
	...
	public function list_by_jenis($jenis)
	{
		...
		$this->db->where('date_format(mulai,"%Y")',date("Y"));
