...
class Anggota_dosen_revisi extends CI_Controller{
    ...
    public function get_anggota_dosen($id = null)
    {
        ...
        $sql = "SELECT id_pengajuan_detail, id_anggota, b.sinta, a.nip, b.file_cv,a.status,b.nama, b.unit,b.jenis_unit FROM anggota_dosen_mandiri a INNER JOIN dummy_dosen b ON a.nip = b.nidn WHERE id_pengajuan_detail = '$id_pengajuan' AND a.status != 0 ";
        if($id !== null){
