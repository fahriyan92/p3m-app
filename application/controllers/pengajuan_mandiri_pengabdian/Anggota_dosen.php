...
class Anggota_dosen extends CI_Controller{
    ...
    public function index()
    {
        ...
        if($cek['status'] == 1){
          ...
          $view = VIEW_DOSEN . 'pengajuan_mandiri_pengabdian/anggota_dosen.php';
            ...
            $view = VIEW_DOSEN . 'pengajuan_mandiri_pengabdian/anggota_dosen_update.php';
    ...
    public function store()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            $data['judul'] = $data['mode'] === 'edit' ? 'Edit Anggota Dosen' :'Tambahkan Anggota Dosen';
            $data['brdcrmb'] = 'Beranda / Penelitian Dosen / Mandiri';
            $data['content'] = VIEW_DOSEN . 'pengajuan_mandiri_pengabdian/anggota_dosen.php';
            $this->load->view('index', $data);        
