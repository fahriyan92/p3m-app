...
class C_penelitian_dsn_pnbp extends CI_Controller
{
    ...
    {
        $sql = "select id_list_event id_event, waktu_mulai mulai,waktu_akhir selesai from tb_list_event where id_jenis_event = 1 AND id_tahapan = 11 AND (curdate() between waktu_mulai AND waktu_akhir) AND status = 1;";
        $data = $this->db->query($sql)->row();
    ...
    public function preview($id = null)
    {
        ...
        $data['pengajuan_url'] = 'C_penelitian_dsn_pnbp/halaman_pengajuan/' . $id . '';
        $data['edit_pengajuan_url'] = 'C_penelitian_dsn_pnbp/halaman_edit/' . $id . '';
        ...
        $dtroposal = $data['dt_proposal'];

        // $listLuaran = $this->pemonev->relasiTargetLuaran($id);

        // var_dump($check_isAnggota);

        $this->load->view('index', $data);
    }

    public function halaman_pengajuan_evaluasi($id)
    {
        if ($id == null) {
            $this->session->set_flashdata('error_access', 'Halaman Tidak Dapat Di Akses');
            redirect("C_penelitian_dsn_pnbp");
        ...
        $data['dt_proposal'] = $this->reviewer->get_proposalnya($id);
        $data['berkas'] = $this->pemonev->dataBerkas_evaluasi_penelitian($id);
        $data['deskripsi'] = $this->pemonev->dataDeskripsi_evaluasi_pengabdian($id);

        if ($kelompok_pengajuan->id_kelompok_pengajuan == "14") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PKLN';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "12") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PVUJ';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "10") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PTM';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "11") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_KKS';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "2") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PDP';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "13") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PKK';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } elseif ($kelompok_pengajuan->id_kelompok_pengajuan == "9") {
            $data['namakelompok'] = $kelompok_pengajuan->nama_kelompok;
            $data['content'] = VIEW_DOSEN . 'evaluasi/penelitian/content_penelitian_evaluasi_PLP';
            $data['terbit'] = $data['dt_proposal']->tahun_usulan;
        } else {

        }
        // var_dump($test->b_laporan_akhir);
        $this->load->view('index', $data);
    }
    ...
    public function index()
    {
        ...
        $data['get_proposal'] = $this->pnbp->list_proposal_status_penelitian($this->session->userdata('nidn'), '1')->result();
    ...
    public function store_pengajuan_kedua()
    {
        ...
        $insert = $this->pnbp->store_pengajuan_kedua($insertkan);
        if ($insert) {
    ...
    public function insert_anggota_polije()
    {
        ...
        if ($id_pengajuan_detail == null) {
            ...
            $this->pnbp->insert_temp_anggota_polije($data);
        } else {
            $data = [
            ...
            $this->pnbp->insert_not_temp_anggota_polije($data);
        }
    ...
    public function insert_temp_anggota_luar()
    {
        ...
        if ($id_pengajuan_detail == null) {
            $this->pnbp->insert_temp_anggota_luar($data_temp, $data_anggota_luar);
        } else {
            $this->pnbp->insert_not_temp_dosen_luar($data_anggota_pengajuan_luar, $data_anggota_luar);
        }
    ...
    {
        $data = $this->pnbp->get_where('tb_st_skema_event', ['id_list_event' => $id_list_event, 'id_skema' => $id_skema])->row();
