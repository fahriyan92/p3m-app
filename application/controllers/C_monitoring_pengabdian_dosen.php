...
class C_monitoring_pengabdian_dosen extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('M_luaranwajib', 'masagabisa');
        date_default_timezone_set('Asia/Jakarta');
    }

    public function simpan_laporan()
    {
        $jenisLuaran    = $this->input->post('targetLuaran');
        $prosentase    = $this->input->post('prosentase');
        $file    = $this->input->post('fileLaporan');
        ...
        $this->masagabisa->tambah_laporan($data);
        redirect(base_url(''));
    }
    ...
    public function preview($id = null)
    {
        ...
        redirect(base_url(''));
        $username = $this->session->userdata('username');
        $data['content'] = VIEW_DOSEN . 'content_preview_pengabdian';
        $data['username'] = $username;
        ...
        $data['daftarluar'] = $this->masagabisa->tampil_luaran();
        $data['laporan'] = $this->masagabisa->progress();
    ...
    public function index()
    {
        ...
        $data['content'] = VIEW_DOSEN . 'content_status_monitoring_pengabdian';
    ...
    {
        $sql = "select nidn,nama,jenis_job,jenis_unit,unit,sinta,scopus,file_cv from dummy_dosen WHERE file_cv != '' AND sinta != '' ";
        $query = $this->db->query($sql)->result();
