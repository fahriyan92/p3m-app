...
class Proposal_pengabdian extends RestController
{
    ...
    public function index_get()
    {
        ...
        $w_pnbp = " WHERE a.id_pengajuan_detail IN (SELECT DISTINCT id_pengajuan_detail FROM tb_kerjaan_reviewer WHERE kerjaan_selesai = 1)  AND d.id_jenis_event = 2 AND 
	            a.status_keputusan = 1";
        $w_mandiri = " WHERE b.id_jenis = 2 AND a.status_koreksi = 1 AND a.status = 8";
