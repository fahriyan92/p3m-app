...
class Upload_berkas_pengabdian extends CI_Controller
{
    ...
    public function tambah_deskripsi_kemajuan($id)
    {
        ...
        $masuk = $this->db->insert('tb_deskripsi_evaluasi_pengabdian', $dataDeskripsi);
        ...
        if ($masuk) {
            ...
            redirect('C_pengabdian_dsn_pnbp/halaman_pengajuan_evaluasi/' . $id);
            Exit();
        } else {
    ...
    public function edit_deskripsi_kemajuan($id)
    {
        ...
        $deskripsiList = $this->pengabdian->deskripsiBerkas_evaluasi($id);
        ...
        $masuk = $this->db->update('tb_deskripsi_evaluasi_pengabdian', $dataDeskripsi);
    ...
    public function hapus_deskripsi_kemajuan($id)
    {
        ...
        $berkas = $this->pemonev->dataBerkas_evaluasi_pengabdian($id);
        ...
        $this->db->where('nidn', $nidn);
        $this->db->where('id_pengajuan_detail', $id);
        $update = $this->db->update('tb_deskripsi_evaluasi_pengabdian', $dataBerkas);
        if ($update) {
            $res = $this->response([1, 'Berhasil Tambah ']);
            echo json_encode($res);
    ...
    public function up_berkas_laporan_kemajuan($id)
    {
        ...
        $dir_laporan = realpath(APPPATH . '../assets/berkas/file_laporan/pengabdian/');
        ...
        $insert = $this->pemonev->insert('tb_berkas_evaluasi_pengabdian', $dataBerkas);
        if ($up_berkas) {
            $res = $this->response([1, 'Berhasil Tambah ']);
            echo json_encode($res);
    ...
    public function edit_berkas_laporan_kemajuan($id)
    {
        ...
        if (isset($_FILES['berkas_laporan_kemajuan']['name'])) {
            $dir_berkas = realpath(APPPATH . '../assets/berkas/file_laporan/pengabdian/');
        ...
        $this->db->where('nidn', $nidn);
        $this->db->where('id_pengajuan_detail', $id);
        $this->db->update('tb_berkas_evaluasi_pengabdian', $dataBerkas);
        if ($up_berkas) {
            $res = $this->response([1, 'Berhasil Tambah ']);
            echo json_encode($res);
    ...
    public function up_berkas_laporan_kemajuan_url($id)
    {
        ...
        $this->db->where('nidn', $nidn);
        $this->db->where('id_pengajuan_detail', $id);
        $masuk = $this->db->insert('tb_berkas_evaluasi_pengabdian', $dataBerkas);
    ...
    public function edit_berkas_laporan_kemajuan_url($id)
    {
        ...
        $berkas = $this->pemonev->dataBerkas_evaluasi_pengabdian($id);
        $deskripsiModel = $this->pengabdian->deskripsiBerkas_evaluasi($id);
        ...
        $dataBerkas = array(
            'b_laporan_kemajuan' => isset($_POST['berkas_laporan_kemajuan_url']) ? $url : $berkas->b_laporan_kemajuan,
        );
        $dataDeskripsi = array(
            'd_laporan_kemajuan' => isset($_POST['deskripsi_kemajuan']) ? $deskripsi : $deskripsiModel->d_laporan_kemajuan,
        );

        $this->db->where('nidn', $nidn);
        $this->db->where('id_pengajuan_detail', $id);
        $update = $this->db->update('tb_berkas_evaluasi_pengabdian', $dataBerkas);
    ...
    public function up_wb5($id)
    {
        ...
        $nama_filenya = $this->namabaru_evaluasi($data_nama->nama, $this->session->userdata('nidn'), "luaran_wajib_5");
        $dir_laporan = realpath(APPPATH . '../assets/berkas/file_laporan/pengabdian/');
        $name_berkas = $_FILES['wb5']['name'];
        $extension_berkas = substr($name_berkas, strpos($name_berkas, '.'), strlen($name_berkas) - 1);
        $nm_berkas = $nama_filenya . $extension_berkas;
        $tmp_berkas = $_FILES['wb5']['tmp_name'];
    ...
    public function edit_wb5($id)
    {
        ...
        $dataBerkas = array(
            'w_b5' => isset($_FILES['wb5']['name']) ? $nm_berkas : $post['berkas_lama'],
        );
    ...
    public function edit_wb5_url($id)
    {
        $dataprops = $this->reviewer->get_proposalnya($id);
        $nidn = $dataprops->nidn_ketua;
        ...
        $dataBerkas = array(
            'w_b5' => isset($_POST['wb5']) ? $url : $berkas->w_b5,
        );
