...
class M_rekap extends CI_Model{
    public function get_proposal($tahun,$type,$status){
        //type 1 = penelitian, 2 = pengabdian, status = NULL belum diproses, 1 = diterima , 2 = ditolak
