                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="number" class="form-control" name="sinta1" value="<?= isset($edit_ketua) ? $edit_ketua->sinta : '' ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                                    ...
                                    <?php if(isset($edit_ketua)): ?>
                                        <input type="hidden" id="id_anggota_ketua" value="<?= $edit_ketua->id_anggota?>">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="file_cv">File CV</label>
                                            <div>
                                            <a href="<?=base_url('assets/berkas/file_cv/').$edit_ketua->file_cv?>" class="cvnya"><?= $edit_ketua->file_cv ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endif; ?>
              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          <label for="id_sinta">5. ID-Sinta <span style="color:red;">*</span></label>
                          <div class="custom-file">
                              <input type="number" class="form-control" name="sinta1" value="" id="id_sinta2" onkeydown="return event.keyCode !== 69" name="id_sinta">
                  ...
                  <div class="col-md-12">
                  <div class="form-group">
                      <label for="cvAnggota">6. Unggah CV Dosen</label>
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="cvAnggota" name="cv1" hidden="hidden">
                          <label class="custom-file-label" for="cvAnggota" id="labelCvAnggota">Pilih file</label>
                      </div>
                      <div class="err-cv-anggota" style="display:none;">
                          <h5 style="font-size: 16px; color: red;" class="text-left"></h5>
                      </div>
                  </div>
              ...
              <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input type="hidden" id="id-edit">
                              <input type="number" class="form-control"  id="sinta-edit" onkeydown="return event.keyCode !== 69" >
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div>
                        <a href="#" class="label-cv">asdlfkasjdflasdflasdfl.pdf</a>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                  <div class="form-group">
                      <label for="cv-edit">6. Unggah CV Dosen</label>
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="cv-edit" name="cv1" hidden="hidden">
                          <label class="custom-file-label" for="cv-edit" id="labelCvEdit">Pilih file</label>
                      </div>
                      <div class="err-cv-anggota-edit" style="display:none;">
                          <h5 style="font-size: 16px; color: red;" class="text-left"></h5>
                      </div>
                  </div>
...
<script>
    ...
    const list_anggota = function(){
        get_anggota().then(res => {
            if(res.data.length > 0){
                ...
                $('#list-anggota').html('<h5 class="mt-4" style="color:red">Lengkapi data diri anda dulu</h5>');
            }
        });
    };    
   ...
   $('select[name="nip2"]').select2();
    const get_anggota = function(id = null){
        let url = `<?= base_url('pengajuan_mandiri_pengabdian/anggota_dosen_revisi/get_anggota_dosen')?>`;
        if(id !== null) url += `/${id}`;
    ...
    const insert = function(form_data){
        let url = `<?= base_url('pengajuan_mandiri_pengabdian/anggota_dosen_revisi/store')?>`;
        return new Promise((resolve,reject) => {
            $.ajax({
                url: url,
                dataType: 'json',
    ...
    const update = function(form_data){
        let url = `<?= base_url('pengajuan_mandiri_pengabdian/anggota_dosen_revisi/update')?>`;
        return new Promise((resolve,reject) => {
            $.ajax({
                url: url,
                dataType: 'json',
    ...
    const validasi = function (jenis){
        let status = {nip:false,sinta:false,cv:false};
