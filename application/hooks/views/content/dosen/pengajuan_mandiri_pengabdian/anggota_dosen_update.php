...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                    <form action="<?= site_url('pengajuan_mandiri_pengabdian/anggota_dosen/update') ?>" method="post" enctype="multipart/form-data">
                    
                        <div class="form-group">
                            <label for="ketua">1. NIP</label>
                            <input type="text" class="form-control" name="nip1" readonly id="nidn_ketua" value="<?= $dosen['ketua'][0]->nidn ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="number" class="form-control" name="sinta1" value="<?= $edit_ketua->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_cv/').$edit_ketua->file_cv ?>" target="_blank"><?= $edit_ketua->file_cv ?></a></h5>
                                <input type="hidden" value="<?= $edit_ketua->file_cv ?>" name="cv1">
                            </div>
                        </div>                        

                        <div class="col-md-12">
                        <div class="form-group">
                            <label for="cvKetua">6. Unggah CV Ketua <span style="color:red;"></span></label>
                            <div class="custom-file">
                            ...
                            <div class="err-cv-ketua" style="display:none;">
                                <h5 style="font-size: 16px; color: red;" class="text-left">File Harus PDF!</h5>
                            </div>
                        </div>
                        </div>
                ...
                <?php //start ?>
                <?php if($edit_anggota !== null): ?>

                <?php if(count($edit_anggota) > 1): ?>    
                
                <?php $no = 1; foreach($edit_anggota as $anggota):?>    
                    <h3 class="text-left">Data Anggota <?= $no ?> <span style="color:red;">*</span></h3>
                    <?php if($anggota->status == 1): ?> 
                    
                        <h4 class="text-left"><?= $anggota->nip . ' - '. $anggota->nama ?><span style="color:black;"> (Belum merespon)</span></h4>
                        <hr>                        
                    <?php elseif($anggota->status == 2): ?>

                <div class="row">
                    <div class="col-md-12">
                    <div class="form-group">
                        <label for="anggota1">1. NIP Anggota <?= $no ?></label>
                        <input type="number" class="form-control" name="nip<?= $no + 1 ?>" value="<?= $anggota->nip ?>" readonly onkeydown="return event.keyCode !== 69">
                    </div>     
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                                <label for="nidn">2. NAMA DOSEN</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" name="nama_dosen" id="nama1" value="<?= $anggota->nama ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="jurusan">3. Jurusan</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" name="jurusan" id="jurusan1" value="<?= $anggota->unit ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="pangkat">4. Pangkat / Jabatan Fungsional</label>
                                <div class="custom-file">
                                    <input type="text" class="form-control" id="pangkat1"  name="pangkat" value="<?= $anggota->jenis_unit ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="id_sinta">5. ID-Sinta <span style="color:red;">*</span></label>
                                <div class="custom-file">
                                    <input type="number" class="form-control" name="sinta<?= $no+1; ?>" value="<?= $anggota->sinta ?>" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="id_sinta">File CV Anggota <?= $no ?></label>
                                <h5 class="text-left"><a href="<?= base_url('assets/berkas/file_cv/').$anggota->file_cv ?>" target="_blank"><?= $anggota->file_cv ?></a></h5>
                                <input type="hidden" value="<?= $anggota->file_cv ?>" name="cv<?= $no+1 ?>">
                            </div>
                        </div>                            
                        <div class="col-md-12">
                        <div class="form-group">
                            <label for="cvKetua">6. Unggah CV Anggota <?= $no ?><span style="color:red;">*</span><?= isset($lanjut_dosen) && isset($lanjut_dosen['ketua']) ? '<span style="color:red;">(Jika tidak ingin mengganti cv bisa dikosongi)</span>' : '' ?></label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="cvAnggota<?= $no ?>" name="cv<?= $no+1; ?>" hidden="hidden">
                                <label class="custom-file-label" for="cvAnggota<?= $no ?>" id="labelAnggota<?= $no ?>">Pilih file</label>
                            </div>
                           <?= form_error('cv2', '<h5  class="text-left" style="color:red;font-size: 16px;">','</h5>') ;?> 
                            
                            <div class="err-cv-anggota<?= $no ?>" style="display:none;">
                                <h5 style="font-size: 16px; color: red;" class="text-left">File Harus PDF!</h5>
                            </div>
                        </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="anggota1">1. NIP Anggota <?= $no ?></label>
                        <input type="text" class="form-control" readonly name="nip<?= $no+1 ?>" value="<?= $anggota->nip ?>" onkeydown="return event.keyCode !== 69">
                    </div>     
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="cvAnggota<?= $no ?>" name="cv<?= $no+1; ?>" hidden="hidden">
                                <label class="custom-file-label" for="cvAnggota<?= $no ?>" id="labelAnggota1">Pilih file</label>
                            </div>
                           <?= form_error('cv2', '<h5  class="text-left" style="color:red;font-size: 16px;">','</h5>') ;?> 
        ...
        <h3 class="text-left">Data Anggota 2 (Opsional)</h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="number" class="form-control" name="sinta3" value="" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                                </div>
                                <div class="err-sinta1" style="display:none;">
                                    <h5 style="font-size: 16px; color: red;" class="text-left">Tidak Boleh Kosong</h5>
                                </div>
            ...
            <?php // kalo anggotanya nolak semua ato gak ada yang 1 dan 2 anggotanya ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="id_sinta">5. ID-Sinta <span style="color:red;">*</span></label>
                            <div class="custom-file">
                                <input type="number" class="form-control" name="sinta2" value="" id="id_sinta1" onkeydown="return event.keyCode !== 69" name="id_sinta">
                            </div>
                    <?= form_error('sinta2', '<h5  class="text-left" style="color:red;font-size: 16px;">','</h5>') ;?> 
                    ...
                    <div class="col-md-12">
                    <div class="form-group">
                        <label for="cvKetua">6. Unggah CV Anggota 1<span style="color:red;">*</span></label>
                        <div class="custom-file">
