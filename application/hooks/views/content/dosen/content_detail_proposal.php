                    ...
                    <?php if (!empty($dt_proposal)) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a data-id-proposal="<?= $dt_proposal->id_pengajuan_detail ?>" data-tmbl="1" href="#" class="btn btn-sm btn-success tombol_terima ml-2" style="margin: auto; width:auto; float:right;"> <i class="fa fa-paste"></i> Terima Permintaan</a>
                                <a data-id-proposal="<?= $dt_proposal->id_pengajuan_detail ?>" data-tmbl="2" href="#" class="btn btn-sm btn-danger tombol_tolak" style="margin: auto; width:auto; float:right;"> <i class="fa fa-paste"></i> Tolak Permintaan</a>
                            </div>
                        </div>
                    <?php endif ?>
                </div>
