                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= empty($dt_proposal) !== true ? $dt_proposal->tema : '' ?>" class="form-control" placeholder="Tema Pengabdian" name="tema_penelitian">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputJudul">5. Sasaran Mitra (Jika Ada)</label>
                                        <input type="text" value="<?= empty($dt_proposal) !== true ? $dt_proposal->sasaran !== "null" ? $dt_proposal->sasaran : '' : '' ?>" class="form-control" id="inputSasaran" placeholder="Sasaran Pengabdian" name="sasaran_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= empty($dt_proposal) !== true ? $dt_proposal->judul : '' ?>" class="form-control" placeholder="Judul Pengabdian" name="judul_penelitian">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= empty($dt_proposal) !== true ? $dt_proposal->tahun_usulan : '' ?>" class="form-control" min="2020" max="2099" step="1" name="tahun_penelitian">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
