        ...
        <div class="container-fluid">
            ...
            <div id="tabs">
                <ul class="nav nav-pills" style="text-align:center;">
                    <li class="nav-item" style="width: 49%;"><a href="#tabs-1" class="nav-link active" data-toggle="tab" style="border-color:lightgrey; width:100%;">Penelitian</a></li>
                    <li class="nav-item" style="width: 50%;"><a href="#tabs-2" class="nav-link" data-toggle="tab" style="border-color:lightgrey; width:100%;">Pengabdian</a></li>
                </ul>
