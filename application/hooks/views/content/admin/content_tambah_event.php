                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php foreach ($jenis_event as $event) { ?>
                                                        ...
                                                        <span for="inputJenis"><?= $event->nm_event ?></span><br>
                                                    <?php } ?>
                    ...
                    <div class="card card-default">
                        <div class="card-header d-flex">
                            ...
                            <ul class="nav nav-pills ml-auto p-2">
                                <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">PENELITIAN</a></li>
                                <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">PENGABDIAN</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <div class="table-responsive mb-5 text-nowrap">
                                        <h3 class="card-title text-center">PNBP PENELITIAN <span class="titel-thn"></span></h3>
