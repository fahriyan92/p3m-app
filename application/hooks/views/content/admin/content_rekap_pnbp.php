            ...
            <div class="card">
                <div class="card-default">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link jenis-event" href="#" data-list="1" style="margin-left: 5px;">Diterima</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link jenis-event " href="#" data-list="2" style="margin-left: 5px;">Ditolak</a>
                        </li>
                    </ul>
                </div>
                <!-- /.card-header -->
...
<script src="<?= base_url() . JS_UMUM; ?>staff_rekap.js?random=<?= uniqid(); ?>"></script>