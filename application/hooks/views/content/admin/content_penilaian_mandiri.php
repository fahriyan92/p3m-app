            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($dt_proposal)) : ?>
                        ...
                        <?php if($dt_proposal->status_koreksi != 1): ?>
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-penerimaan" style="margin: auto; width:auto; float:right;"> <i class="fa fa-paste"></i> Form Komentar</a>
                            </div>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
...
<div class="modal fade" id="modal-penerimaan">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">


                <div class="modal-header">
                    <h4 class="modal-title">Form Komentar Proposal</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                        <form method="post" action="<?= site_url('C_nilai_mandiri/store_komentar');?>" >
                            <div class="form-group">
                                <label for="soalangket">Penerimaan Proposal</label>
                            ...
                            <div class="form-group">
                                <label for="soalangket">Komentar Proposal</label>
                                <textarea class="form-control" id="soal" name="komentar" value="" style="height: 100px;"></textarea>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="submit" class="btn btn-success" style="width: 200px;">Kirim</button>
                    </div>
                    </form>
                </div>
