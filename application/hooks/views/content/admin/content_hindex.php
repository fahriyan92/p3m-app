                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-1" style="text-align: right;">
                            <a href="<?= base_url('C_hindex/tambah_Hindex'); ?>" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Limit</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                                ...
                                <table id="tabelevent" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">Limit Pengajuan Penelitian</th>
                                            <th class="text-center" width="10%">Limit Pengajuan Pengabdian</th>
