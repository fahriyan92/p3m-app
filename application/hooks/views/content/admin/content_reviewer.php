            ...
            <div class="card card-default">
                <ul class="nav nav-tabs">
                    <?php foreach ($list_event->result() as $event) : ?>
                        <li class="nav-item">
                            <a class="nav-link jenis-event" href="#" data-list="<?= $event->id_jenis_event ?>"><?= $event->nm_event ?>-<?= $event->nm_pendanaan ?></a>
                        </li>
                    <?php endforeach ?>
                    <li class="nav-item mr-2" style="width: 130px;"></li>
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table id="tabelevent" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th class="text-center" width="20%">Judul Proposal</th>
...
<script type="text/javascript" src="<?= base_url() . JS_UMUM . 'staff_reviewer.js?' . 'random=' . uniqid() ?> "></script>
