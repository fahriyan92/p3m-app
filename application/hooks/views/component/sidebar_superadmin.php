          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item has-treeview <?= $url === 'C_reviewer' || $url2 ===  'dsnReviewer' ? 'menu-open' : '' ?>">
                      <a href="" class="nav-link <?= $url === 'C_reviewer' || $url2 ===  'dsnReviewer' ? 'active' : '' ?>">
                  ...
                  <li class="nav-item has-treeview <?= $url === 'C_master_data' || $url2 ===  'dsnReviewer' ? 'menu-open' : '' ?>">
                      <a href="" class="nav-link <?= $url === 'C_master_data' || $url2 ===  'dsnReviewer' ? 'active' : '' ?>">
                  ...
                  <li class="nav-item">
                      <a href="<?= base_url("C_user_admin") ?>" class="nav-link <?= $url === 'C_user_admin' ? 'active' : '' ?>">
                  ...
                  <hr style="color: #696969; border: 1px solid; width:100%; margin:5px;">
                  <li class="nav-item">
                      <a href="<?= base_url("C_log") ?>" class="nav-link <?= $url === 'C_log' ? 'active' : '' ?>">
