...
class C_reviewer extends CI_Controller
{
    ...
    public function get_tahun_proposal()
    {
        ...
        $output = '';
        $get = $this->reviewer->get_tahun_proposal($id, $tahun);
        ...
        if ($get->num_rows() > 0) {
            ...
            foreach ($get->result() as $key) {
                ...
                if ($key->status_permintaan == 1) {
                    $output .= '
                              <a href="#" class="btn btn-sm btn-success"> Menerima Permintaan</a>';
                } else {
                    $output .= '
                              <a href="#" class="btn btn-sm btn-warning"> Menunggu Konfirmasi</a>';
                }
                $output .= '
                                   </td>
                                  </tr>';
