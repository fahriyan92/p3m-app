...
class Proposal_penelitian extends RestController {
    ...
    public function index_get()
    {
        ...
        $q_pnbp = "
            ...
            WHERE a.id_pengajuan_detail IN (SELECT DISTINCT id_pengajuan_detail FROM tb_kerjaan_reviewer WHERE kerjaan_selesai = 1)  AND d.id_jenis_event = 1 AND 
        ...
        $q_mandiri = "
            ...
            WHERE b.id_jenis = 1 AND a.status_koreksi = 1 AND a.status = 8
        ";
