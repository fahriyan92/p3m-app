...
class C_dashboard extends CI_Controller
{
	...
	public function get_max_pengajuan($nidsn, $event)
	{
		...
		return $event == 1 ? $max_pengajuan->limit_penelitian : $max_pengajuan->limit_pengabdian;
	}
	public function tombol_permintaan()
	{
		...
		if ($id != '') {
			...
			if ($status == 2) {
				...
				$this->db->update('tb_hindex', $cek->id_event == 1 ? ['limit_penelitian' => $get_max - 1] : ['limit_pengabdian' => $get_max - 1]);
