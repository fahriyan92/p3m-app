...
function check_status_anggota() {
  ...
  $.get(
    `${BASE_URL}C_pengabdian_dsn_pnbp/check_permintaan_anggota/${
...
$("#b_test2").click(function () {
  ...
  const nidn_coba = $('input[name="nidn1"]').val();
  ...
  $('[name="nidn1"]').each(function () {
    nidn.push($(this).val());
  });

  $('[name="id_sinta1"]').each(function () {
    sinta.push($(this).val());
  });
  ...
  $.ajax({
    ...
    url: `${
      $(this).val() === "simpan"
        ? `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan_edit_satu`
        : `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan_edit_satu`
    }`,
    data: form_data,
    contentType: false,
    ...
    success: function (data) {
      if (data.code === 1) {
        ...
        setTimeout(function () {
          window.location.replace(`${BASE_URL}C_pengabdian_dsn_pnbp`);
        }, 2000);
      } else {
        $("#overlay").fadeOut(400);
...
$("#b_test").click(function () {
  ...
  $.ajax({
    type: "POST",
    dataType: "json",
    url: `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan_edit_dua`,
    data: form_data,
    contentType: false,
    cache: false,
    processData: false,
