...
$("#b_test2").click(function () {
  ...
  if ($(this).val() === "simpan") {
    ...
    if ($('input[name="id_pengajuan"]').length === 1) {
      form_data.append("id_pengajuan", $('input[name="id_pengajuan"]').val());
  ...
  $.ajax({
    ...
    url: `${
      $(this).val() === "simpan"
        ? `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan`
        : `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan`
    }`,
    data: form_data,
    contentType: false,
...
$("#b_test").click(function () {
  ...
  $.ajax({
    type: "POST",
    dataType: "json",
    url: `${BASE_URL}C_pengabdian_dsn_pnbp/store_pengajuan_kedua`,
    data: form_data,
    contentType: false,
    cache: false,
    processData: false,
