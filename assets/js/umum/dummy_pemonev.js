function modal_proposal($id) {
    ...
    $.ajax({
      url: `${BASE_URL}C_Pemonev/get_modal`,
      method: "POST",
      data: { idnya: idnya },
      dataType: "json",
  ...
  const fokus_skema_list = function(id = null){
    ...
    $.ajax({
      url: `${BASE_URL}C_Pemonev/fokus_skema_list`,
      method: "POST",
  ...
  $(document).ready(function () {
    ...
    $("#clicker").click(function () {
      ...
      $.ajax({
        type: "POST",
        dataType: "json",
        url: `${BASE_URL}C_reviewer/insert_reviewer`,
        data: {
    ...
    $("#dl_excel").on("click",function(e){
      ...
      let link = BASE_URL + "export_excel/export_pnbp?id_event="+event[id_jenis]+"&tahun="+tahun+"&skema="+skema+"&fokus="+fokus;
